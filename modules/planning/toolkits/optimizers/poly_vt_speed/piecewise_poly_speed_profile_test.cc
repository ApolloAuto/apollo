...
#include "modules/planning/toolkits/optimizers/poly_vt_speed/piecewise_poly_speed_profile.h"
...
#include "modules/planning/toolkits/optimizers/poly_vt_speed/piecewise_poly_speed_curve.h"
