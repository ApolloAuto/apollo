...
#ifndef MODULES_DRIVERS_STREAM_STREAM_H_
#define MODULES_DRIVERS_STREAM_STREAM_H_
...
class Stream {
 public:
  ...
  // // Returns how many bytes it was successful to write.
  // virtual size_t broadcast_write(const uint8_t *buffer, size_t length) = 0;
...
#endif  // MODULES_DRIVERS_STREAM_STREAM_H_
