...
bool SpiralProblemInterface::get_bounds_info(int n, double* x_l, double* x_u,
  ...
  // b. for delta_s
  size_t variable_offset = num_of_points_ * 5;
  for (size_t i = 0; i + 1 < num_of_points_; ++i) {
  ...
  size_t constraint_offset = 2 * (num_of_points_ - 1);
  for (size_t i = 0; i < num_of_points_; ++i) {
...
bool SpiralProblemInterface::eval_f(int n, const double* x, bool new_x,
  ...
  for (size_t i = 0; i + 1 < num_of_points_; ++i) {
    ...
    for (size_t j = 0; j < num_of_internal_points_; ++j) {
...
bool SpiralProblemInterface::eval_jac_g(int n, const double* x, bool new_x,
  ...
  if (values == nullptr) {
    ...
    size_t variable_offset = num_of_points_ * 5;
    for (size_t i = 0; i + 1 < num_of_points_; ++i) {
      int variable_index = static_cast<int>(i) * 5;
...
bool SpiralProblemInterface::eval_h(int n, const double* x, bool new_x,
  ...
  if (values == nullptr) {
    ...
    size_t variable_offset = 5 * num_of_points_;
    for (size_t i = 0; i + 1 < num_of_points_; ++i) {
      iRow[index] = i * 5;
