...
DEFINE_string(root_dir, "modules/perception/camera/tools/obstacle_detection", "image root dir");
DEFINE_string(image_ext, ".jpg", "extension of image name");
DEFINE_string(test_list, "modules/perception/camera/tools/obstacle_detection/images/image_test_list.txt", "test image list");
DEFINE_string(obstacle_detection_conf_file, "modules/perception/camera/tools/obstacle_detection/conf/camera_detection_pipeline.pb.txt", "Camera perception config file");
DEFINE_string(camera_intrinsics, "modules/perception/camera/tools/obstacle_detection/params/onsemi_narrow_intrinsics.yaml", "Camera intrinsic file");
