...
#include "modules/drivers/cidiv2x/stream/tcp_stream.h"
...
size_t TcpStream::read(uint8_t* buffer, size_t max_length, uint8_t flag) {
  ssize_t ret = 0;
...
size_t TcpStream::write(const uint8_t* buffer, size_t length, uint8_t flag) {
