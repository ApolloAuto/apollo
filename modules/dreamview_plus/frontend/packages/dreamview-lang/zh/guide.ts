export const guide = {
    ...
    // modeDefaultDesc: '默认模式沿用旧版dreamview布局，适用于所有开始调试的场景。',
    // defaultMode: '默认模式',
    // perceptionMode: '感知模式',
    // enterThisMode: '进入该模式',
    ...
    PNCSelectOperations: 'PNCSelectOperations',
    PNCSelectOperationsDesc: 'PNCSelectOperationsDesc.',
    PNCSelectModules: 'PNCSelectModules',
    PNCSelectModulesDesc: 'PNCSelectModulesDesc',
    PNCResourceManager: 'PNCResourceManager',
    PNCResourceManagerDesc: 'PNCResourceManagerDesc',
    PNCSelectScenario: 'PNCSelectScenario',
    PNCSelectScenarioDesc: 'PNCSelectScenarioDesc',
    PNCSelectMap: 'PNCSelectMap',
    PNCSelectMapDesc: 'PNCSelectMapDesc',
    PNCSelectADS: 'PNCSelectADS',
    PNCSelectADSDesc: 'PNCSelectADSDesx',
    PNCSetRoute: 'PNCSetRoute',
    PNCSetRouteDesc: 'PNCSetRouteDesc',
    PNCSimulationRecord: 'PNCSimulationRecord',
    PNCSimulationRecordDesc: 'PNCSimulationRecordDesc',
