...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_CRUISE_CONTROL_BUTTONS_RPT_208_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_CRUISE_CONTROL_BUTTONS_RPT_208_H_
...
class Cruisecontrolbuttonsrpt208 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Cruise_control_buttons_rpt_208::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Cruise_control_buttons_rpt_208::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Cruise_control_buttons_rpt_208::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
