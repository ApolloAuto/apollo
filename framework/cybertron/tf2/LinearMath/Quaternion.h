...
#ifndef CYBERTRON_TF2_LINEARMATH_QUATERNION_H_
#define CYBERTRON_TF2_LINEARMATH_QUATERNION_H_
...
class Quaternion : public QuadWord {
  ...
  * @param q The other quaternion */
  ...
  /**@brief Return the angle of rotation represented by this quaternion along
   * the shortest path*/
   ...
   * is this, if t=1 the result is q.
...
TF2SIMD_FORCE_INLINE Quaternion
shortestArcQuat(const Vector3& v0, const Vector3& v1)  // Game Programming
                                                       // Gems 2.10. make
                                                       // sure v0,v1 are
                                                       // normalized
{
  Vector3 c = v0.ccybertrons(v1);
