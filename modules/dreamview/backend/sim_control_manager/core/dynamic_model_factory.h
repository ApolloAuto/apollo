...
#include "modules/dreamview/backend/sim_control_manager/sim_control_base.h"
...
class DynamicModelFactory {
 public:
  ...
  std::unique_ptr<SimControlBase> GetModelType(std::string dynamic_model_name);
 ...
 private:
  DynamicModelFactory():dynamic_model_local_path_(""){
