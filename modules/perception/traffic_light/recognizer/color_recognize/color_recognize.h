...
#ifndef ADU_PERCEPTION_TRAFFIC_LIGHT_RECOGNIZE_COLOR_RECOGNIZE_H
#define ADU_PERCEPTION_TRAFFIC_LIGHT_RECOGNIZE_COLOR_RECOGNIZE_H
...
class ColorRecognize : public BaseRecognizer {
 public:
  ColorRecognize() {
  }
