...
/**
 * @file path_follow_command_processor.h
 **/
...
class PathFollowCommandProcessor : public MotionCommandProcessorBase<PathFollowCommand> {
private:
    /**
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::external_command::PathFollowCommandProcessor, CommandProcessorBase)
