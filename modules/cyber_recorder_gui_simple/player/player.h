...
#include "modules/cyber_recorder_gui_simple/player/play_param.h"
#include "modules/cyber_recorder_gui_simple/player/play_task_buffer.h"
#include "modules/cyber_recorder_gui_simple/player/play_task_consumer.h"
...
public:
    ...
    PlayParam get_parm() {
        return producer_->play_param();
    }

    double last_played_msg_real_time_s() {
        return last_played_msg_real_time_s_.load();
    }
    double progress_time_s() {
        return progress_time_s_.load();
    }
    double total_progress_time_s() {
        return total_progress_time_s_.load();
    }
    bool is_initialized() {
    ...
    bool ResetProcessTime(double process_time);
...
private:
    ...
    std::atomic<double> last_played_msg_real_time_s_;
    std::atomic<double> progress_time_s_;
    std::atomic<double> total_progress_time_s_;
};
