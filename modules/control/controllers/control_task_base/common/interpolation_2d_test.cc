 ...
 public:
  virtual void SetUp() {
    std::string control_base_dir =
        "/apollo/modules/control/controllers/control_task_base/";
    std::string control_conf_file = control_base_dir +
        "conf/calibration_table.pb.txt";
    ACHECK(cyber::common::GetProtoFromFile(
        control_conf_file, &calibration_table_));
  }
