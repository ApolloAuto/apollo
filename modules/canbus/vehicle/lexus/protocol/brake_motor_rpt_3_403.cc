...
void Brakemotorrpt3403::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_brake_motor_rpt_3_403()->set_torque_output(torque_output(bytes, length));
  chassis->mutable_lexus()->mutable_brake_motor_rpt_3_403()->set_torque_input(torque_input(bytes, length));
}
