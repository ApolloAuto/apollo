...
class LidarDetectionSubmodule : public cyber::Component<drivers::PointCloud> {
 public:
  LidarDetectionSubmodule() = default;
  virtual ~LidarDetectionSubmodule() = default;
...
CYBER_REGISTER_COMPONENT(LidarDetectionSubmodule);
