...
#include "modules/perception/proto/radar_submodule_config.pb.h"
...
class RadarDetectionSubmodule : public cyber::Component<ContiRadar> {
 public:
  RadarDetectionSubmodule()
      : seq_num_(0),
        tf_child_frame_id_(""),
  ...
  ~RadarDetectionSubmodule() = default;
 ...
 private:
  ...
  RadarDetectionSubmodule(const RadarDetectionSubmodule&) = delete;
  RadarDetectionSubmodule& operator=(const RadarDetectionSubmodule&) = delete;
...
CYBER_REGISTER_COMPONENT(RadarDetectionSubmodule);
