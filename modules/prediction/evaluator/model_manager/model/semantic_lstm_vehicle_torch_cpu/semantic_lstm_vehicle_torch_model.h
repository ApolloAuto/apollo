...
class SemanticLstmVehicleCpuTorch : public ModelBase {
 public:
  SemanticLstmVehicleCpuTorch() {}
  ~SemanticLstmVehicleCpuTorch() {Destory();}
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
  apollo::prediction::SemanticLstmVehicleCpuTorch, ModelBase)
