...
class MultiAgentPedestrianGpuTorch : public ModelBase {
 public:
  /**
   * @brief constructor
   */
  MultiAgentPedestrianGpuTorch() {}
  /**
   * @brief Destroy the Multi Agent Pedestrian Gpu Torch object
   * 
   */
  ~MultiAgentPedestrianGpuTorch() {Destory();}
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
  apollo::prediction::MultiAgentPedestrianGpuTorch, ModelBase)
