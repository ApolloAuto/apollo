...
bool ObjectSequence::add_tracked_frame_objects(
    ...
    remove_stale_tracks(timestamp);
    _current = timestamp;
    return true;
}

bool ObjectSequence::get_track_in_temporal_window(
        int track_id, 
...
void ObjectSequence::remove_stale_tracks(double current_stamp) {
