...
class LidarTrackingSubmodule : public cyber::Component<LidarFrameMessage> {
 public:
  LidarTrackingSubmodule() : tracker_(nullptr) {}
  ~LidarTrackingSubmodule() = default;
...
CYBER_REGISTER_COMPONENT(LidarTrackingSubmodule);
