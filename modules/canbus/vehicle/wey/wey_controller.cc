...
Chassis WeyController::chassis() {
  ...
  if (wey.has_fbs2_240() && wey.fbs2_240().has_vehiclespd() &&
    ...
    if (fbs2_240.rrwheeldirection() == Fbs2_240::RRWHEELDIRECTION_FORWARD) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rr(WheelSpeed::FORWARD);
    } else if (fbs2_240.rrwheeldirection() ==
                  Fbs2_240::RRWHEELDIRECTION_BACKWARD) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rr(WheelSpeed::BACKWARD);
    } else if (fbs2_240.rrwheeldirection() ==
                  Fbs2_240::RRWHEELDIRECTION_STOP) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rr(WheelSpeed::STANDSTILL);
    } else {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rr(WheelSpeed::INVALID);
    }
    ...
    if (fbs2_240.rlwheeldrivedirection() ==
      ...
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rl(WheelSpeed::FORWARD);
    } else if (fbs2_240.rlwheeldrivedirection() ==
                  Fbs2_240::RLWHEELDRIVEDIRECTION_BACKWARD) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rl(WheelSpeed::BACKWARD);
    } else if (fbs2_240.rlwheeldrivedirection() ==
                  Fbs2_240::RLWHEELDRIVEDIRECTION_STOP) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rl(WheelSpeed::STANDSTILL);
    } else {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_rl(WheelSpeed::INVALID);
    }
    ...
    if (fbs1_243.frwheeldirection() ==
                  Fbs1_243::FRWHEELDIRECTION_FORWARD) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fr(WheelSpeed::FORWARD);
    } else if (fbs1_243.frwheeldirection() ==
                  Fbs1_243::FRWHEELDIRECTION_BACKWARD) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fr(WheelSpeed::BACKWARD);
    } else if (fbs1_243.frwheeldirection() ==
                  Fbs1_243::FRWHEELDIRECTION_STOP) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fr(WheelSpeed::STANDSTILL);
    } else {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fr(WheelSpeed::INVALID);
    }
    ...
    if (fbs2_240.flwheeldirection() ==
                  Fbs2_240::FLWHEELDIRECTION_FORWARD) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fl(WheelSpeed::FORWARD);
    } else if (fbs2_240.flwheeldirection() ==
                  Fbs2_240::FLWHEELDIRECTION_BACKWARD) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fl(WheelSpeed::BACKWARD);
    } else if (fbs2_240.flwheeldirection() ==
                  Fbs2_240::FLWHEELDIRECTION_STOP) {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fl(WheelSpeed::STANDSTILL);
    } else {
      chassis_.mutable_wheel_speed()->
          set_wheel_direction_fl(WheelSpeed::INVALID);
    }
