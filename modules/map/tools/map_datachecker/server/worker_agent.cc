...
MapDataCheckerAgent::MapDataCheckerAgent() {
  sp_conf_ = parse_json(FLAGS_conf_json);
...
void MapDataCheckerAgent::set_worker_cyber_node(
  ...
  cyber_node_ = cyber_node->get_worker_cyber_node();
}
...
grpc::Status MapDataCheckerAgent::ServiceChannelVerify(
  ...
  return sp_channel_checker_agent_->process_grpc_request(context, request,
                                                         response);
}
...
grpc::Status MapDataCheckerAgent::ServiceStaticAlign(
  ...
  return sp_static_align_agent_->process_grpc_request(context, request,
                                                      response);
}
...
grpc::Status MapDataCheckerAgent::ServiceEightRoute(
  ...
  return sp_eight_route_agent_->process_grpc_request(context, request,
                                                     response);
}
...
grpc::Status MapDataCheckerAgent::ServiceLoopsVerify(
  ...
  return sp_loops_verify_agent_->process_grpc_request(context, request,
                                                      response);
}
