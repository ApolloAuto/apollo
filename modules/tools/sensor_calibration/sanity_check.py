...
def missing_lidar_gnss_file(lidar_gnss_config):
    ...
    print("odometry_dir:{} , point_cloud_dir: {}".format(
        odometry_dir, point_cloud_dir))
...
def sanity_check(input_folder):
    ...
    if lidar_gnss_flag and not camera_lidar_flag:
        ...
        info_msg = "{} Passed sanity check.".format(input_folder)
        print(info_msg)
...
def main():
    parser = argparse.ArgumentParser(
        description=
        'A tool to sanity check the output files of extract_data.py.')
    parser.add_argument("--input_folder",
                        action="store",
                        type=str,
                        required=True,
                        dest="input_folder",
                        help="The folder stores extracted messages")
