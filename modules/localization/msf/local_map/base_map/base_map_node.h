...
class BaseMapNode {
 public:
  ...
  // inline const idl::car::core::numerical::Vector2D& get_left_top_corner()
  // const {
  ...
  // idl::car::core::numerical::Vector2D get_coordinate(unsigned int x, unsigned
  // int y) const;

  /**@brief Given the global coordinate, get the local 2D coordinate of the map
   * cell matrix. <return> If global coordinate (x, y) belongs to this map node,
   * eigen version. */
  bool get_coordinate(const Eigen::Vector2d& coordinate, unsigned int& x,
                      unsigned int& y) const;
  bool get_coordinate(const Eigen::Vector3d& coordinate, unsigned int& x,
                      unsigned int& y) const;
  ...
  // static idl::car::core::numerical::Vector2D get_left_top_corner(const
 ...
 protected:
   ...
   */
  virtual unsigned int create_header_binary(unsigned char* buf,
   ...
   * @param <return> The required or the used size of is returned.
   */
  virtual unsigned int create_body_binary(
