...
library_path="${CYBERTRON_PATH}/lib:${CYBERTRON_PATH}/third_party"
...
export PYTHONPATH=${CYBERTRON_PATH}/lib/python:${CYBERTRON_PATH}/lib/python/cybertron:${CYBERTRON_PATH}/lib/python2.7/dist-packages:$PYTHONPATH
