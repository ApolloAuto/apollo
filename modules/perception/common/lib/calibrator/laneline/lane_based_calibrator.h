...
#include "modules/perception/common/lib/calibrator/common/histogram_estimator.h"
#include "modules/perception/common/lib/calibrator/laneline/lane_struct_for_calib.h"
...
class LaneBasedCalibrator {
 ...
 private:
  bool is_in_image(const Eigen::Vector2f &point) const {
    int x = algorithm::IRound(point(0));
    int y = algorithm::IRound(point(1));
    bool is_in_image =
