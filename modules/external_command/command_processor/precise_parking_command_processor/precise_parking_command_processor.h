...
/**
 * @file precise_parking_command_processor.h
 **/
...
class PreciseParkingCommandProcessor : public MotionCommandProcessorBase<PreciseParkingCommand> {
private:
    /**
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::external_command::PreciseParkingCommandProcessor, CommandProcessorBase)
