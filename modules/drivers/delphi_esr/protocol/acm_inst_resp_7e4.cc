...
#include "modules/canbus/vehicle/esr/protocol/acm_inst_resp_7e4.h"
...
void Acminstresp7e4::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_data_7(data_7(bytes, length));
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_data_6(data_6(bytes, length));
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_data_5(data_5(bytes, length));
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_data_4(data_4(bytes, length));
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_data_3(data_3(bytes, length));
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_rtn_cmd_counter(rtn_cmd_counter(bytes, length));
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_command_return_code(command_return_code(bytes, length));
  chassis->mutable_esr()->mutable_acm_inst_resp_7e4()->set_pid(pid(bytes, length));
}
...
int Acminstresp7e4::rtn_cmd_counter(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
int Acminstresp7e4::command_return_code(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
