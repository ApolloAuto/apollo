...
#ifndef MODULES_DRIVERS_LIDAR_VELODYNE_POINTCLOUD_LIB_VELODYNE_PARSER_H_
#define MODULES_DRIVERS_LIDAR_VELODYNE_POINTCLOUD_LIB_VELODYNE_PARSER_H_
...
#include "modules/drivers/lidar_velodyne/pointcloud/lib/calibration.h"
#include "modules/drivers/lidar_velodyne/pointcloud/lib/const_variables.h"
#include "modules/drivers/lidar_velodyne/pointcloud/lib/online_calibration.h"
#include "modules/drivers/lidar_velodyne/pointcloud/lib/point_types.h"
...
class VelodyneParser {
 public:
  ...
  virtual void generate_pointcloud(
      ...
      VPointCloud::Ptr &out_msg) = 0;  // NOLINT
  virtual void setup();
  // order point cloud fod IDL by velodyne model
  virtual void order(VPointCloud::Ptr &cloud) = 0;  // NOLINT
 ...
 protected:
  ...
  void compute_coords(const union RawDistance &raw_distance,
                      ...
                      const uint16_t rotation, VPoint &point);  // NOLINT
   ...
   *
   */
  virtual void unpack(const velodyne_msgs::VelodynePacket &pkt,  // NOLINT
                      VPointCloud &pc) = 0;                      // NOLINT

  double get_gps_stamp(double current_stamp, double &previous_stamp,  // NOLINT
                       uint64_t &gps_base_usec);                      // NOLINT
...
class Velodyne64Parser : public VelodyneParser {
 public:
  ...
  void generate_pointcloud(
      velodyne_msgs::VelodyneScanUnified::ConstPtr scan_msg,
      VPointCloud::Ptr &out_msg);       // NOLINT
  void order(VPointCloud::Ptr &cloud);  // NOLINT
  void setup() override;
...
#endif  // MODULES_DRIVERS_LIDAR_VELODYNE_POINTCLOUD_LIB_VELODYNE_PARSER_H_
