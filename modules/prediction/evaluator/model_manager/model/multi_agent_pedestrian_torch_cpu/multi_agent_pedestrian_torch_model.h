...
class MultiAgentPedestrianCpuTorch : public ModelBase {
 public:
  /**
   * @brief constructor
   */
  MultiAgentPedestrianCpuTorch() {}
  /**
   * @brief Destroy the Multi Agent Pedestrian Cpu Torch object
   * 
   */
  ~MultiAgentPedestrianCpuTorch() {Destory();}
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
  apollo::prediction::MultiAgentPedestrianCpuTorch, ModelBase)
