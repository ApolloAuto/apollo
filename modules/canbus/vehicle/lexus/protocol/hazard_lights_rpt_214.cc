...
void Hazardlightsrpt214::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_output_value(output_value(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_commanded_value(commanded_value(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_manual_input(manual_input(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_vehicle_fault(vehicle_fault(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_pacmod_fault(pacmod_fault(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_override_active(override_active(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_output_reported_fault(output_reported_fault(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_input_output_fault(input_output_fault(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_enabled(enabled(bytes, length));
  chassis->mutable_lexus()->mutable_hazard_lights_rpt_214()->set_command_output_fault(command_output_fault(bytes, length));
}
