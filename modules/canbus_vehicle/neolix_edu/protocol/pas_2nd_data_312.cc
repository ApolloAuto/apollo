...
void Pas2nddata312::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_pas_2nd_data_312()->set_pas_b1_status(
      pas_b1_status(bytes, length));
  chassis->mutable_pas_2nd_data_312()->set_pas_b2_status(
      pas_b2_status(bytes, length));
  chassis->mutable_pas_2nd_data_312()->set_pas_b3_status(
      pas_b3_status(bytes, length));
  chassis->mutable_pas_2nd_data_312()->set_pas_b4_status(
      pas_b4_status(bytes, length));
  chassis->mutable_pas_2nd_data_312()->set_pasdistance1(
      pasdistance1(bytes, length));
  chassis->mutable_pas_2nd_data_312()->set_pasdistance2(
      pasdistance2(bytes, length));
  chassis->mutable_pas_2nd_data_312()->set_pasdistance3(
      pasdistance3(bytes, length));
  chassis->mutable_pas_2nd_data_312()->set_pasdistance4(
