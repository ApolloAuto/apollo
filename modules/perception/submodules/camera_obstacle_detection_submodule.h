...
#include "modules/perception/proto/camera_detection_submodule.pb.h"
...
class CameraObstacleDetectionSubmodule : public apollo::cyber::Component<> {
 public:
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW

 public:
  CameraObstacleDetectionSubmodule() : seq_num_(0) {}
  ~CameraObstacleDetectionSubmodule();

  CameraObstacleDetectionSubmodule(const CameraObstacleDetectionSubmodule&)
                                                                  = delete;
  CameraObstacleDetectionSubmodule&
                operator=(const CameraObstacleDetectionSubmodule&) = delete;
...
CYBER_REGISTER_COMPONENT(CameraObstacleDetectionSubmodule);
