...
#include "modules/prediction/evaluator/model_manager/model/multi_agent_pedestrian_torch_cpu/multi_agent_pedestrian_torch_model.h"
...
bool MultiAgentPedestrianCpuTorch::Init() {
...
bool MultiAgentPedestrianCpuTorch::LoadModel() {
...
bool MultiAgentPedestrianCpuTorch::Inference(
...
void MultiAgentPedestrianCpuTorch::Destory() {}
