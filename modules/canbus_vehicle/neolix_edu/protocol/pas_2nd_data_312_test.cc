...
TEST_F(Pas2nddata312Test, reset) {
  ...
  EXPECT_EQ(cd.pas_2nd_data_312().pas_b1_status(), true);
  EXPECT_EQ(cd.pas_2nd_data_312().pas_b2_status(), true);
  EXPECT_EQ(cd.pas_2nd_data_312().pas_b3_status(), true);
  EXPECT_EQ(cd.pas_2nd_data_312().pas_b4_status(), false);
  EXPECT_EQ(cd.pas_2nd_data_312().pasdistance1(), 196);
  EXPECT_EQ(cd.pas_2nd_data_312().pasdistance2(), 198);
  EXPECT_EQ(cd.pas_2nd_data_312().pasdistance3(), 200);
  EXPECT_EQ(cd.pas_2nd_data_312().pasdistance4(), 162);
}
