...
class Llcmotioncommandfeedback122 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double llc_fbk_brakepressuresetpoint(const std::uint8_t* bytes, const int32_t length) const;
