...
// SAMPLE CODE:
//
// class MyCameraTracker : public BaseCameraTracker {
// public:
//     MyCameraTracker() : BaseCameraTracker() {}
//     virtual ~MyCameraTracker() {}
//
...
//     }
//
//     virtual bool track(const cv::Mat& frame,
...
//          return "MyCameraTracker";
//      }
//
// };
//
// // Register plugin.
// REGISTER_CAMERA_TRACKER(MyCameraTracker);
////////////////////////////////////////////////////////
// USING CODE:
//
// BaseCameraTracker* tracker =
//          BaseCameraTrackerRegisterer::get_instance_by_name("MyCameraTracker");
