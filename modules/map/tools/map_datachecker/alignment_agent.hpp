...
typedef const adu::workers::collection::DynamicAlignRequest DYMAMIC_REQUEST_TYPE;
typedef adu::workers::collection::DynamicAlignResponse DYNAMIC_RESPONSE_TYPE;
typedef const adu::workers::collection::StaticAlignRequest STATIC_REQUEST_TYPE;
typedef adu::workers::collection::StaticAlignResponse STATIC_RESPONSE_TYPE;
typedef const adu::workers::collection::EightRouteRequest EIGHTROUTE_REQUEST_TYPE;
typedef adu::workers::collection::EightRouteResponse EIGHTROUTE_RESPONSE_TYPE;
...
public:
    ...
    grpc::Status process_grpc_request(grpc::ServerContext *context, REQUEST_TYPE *request, RESPONSE_TYPE *response) {
    ...
    int async_start_alignment() {
        ...
        std::thread alignment_thread([=](){
            ...
            //_sp_alignment->set_start_time(_sp_conf->start_time_debug); // debug
            // set_state(AlignmentAgentState::RUNNING);
            ...
            while ( !_need_stop && !apollo::cyber::IsShutdown() ) {
                ...
                AINFO << "thread get progress:" << _sp_alignment->get_progress();
                ...
                std::this_thread::sleep_for( std::chrono::seconds(_sp_conf->alignment_featch_pose_sleep) );
            }
            _stopped = true;
...
typedef AlignmentAgent<StaticAlign, STATIC_REQUEST_TYPE, STATIC_RESPONSE_TYPE> STATIC_ALIGN_AGENT_TYPE;
// typedef AlignmentAgent<DynamicAlign, DYMAMIC_REQUEST_TYPE, DYNAMIC_RESPONSE_TYPE> DYNAMIC_ALIGN_AGENT_TYPE;
typedef AlignmentAgent<EightRoute, EIGHTROUTE_REQUEST_TYPE, EIGHTROUTE_RESPONSE_TYPE> EIGHT_ROUTE_AGENT_TYPE;
