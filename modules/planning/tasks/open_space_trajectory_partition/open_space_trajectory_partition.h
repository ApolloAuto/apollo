...
#include "modules/planning/tasks/open_space_trajectory_partition/proto/open_space_trajectory_partition.pb.h"
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
    apollo::planning::OpenSpaceTrajectoryPartition, Task)
