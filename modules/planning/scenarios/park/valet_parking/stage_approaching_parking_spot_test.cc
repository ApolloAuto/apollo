...
class StageApproachingParkingSpotTest : public StageTestBase {
 public:
  virtual void SetUp() {
    scenario_config_file_ = FLAGS_scenario_valet_parking_config_file;
    stage_type_ = ScenarioConfig::VALET_PARKING_APPROACHING_PARKING_SPOT;
    StageTestBase::SetUp();
  }
};
...
TEST_F(StageApproachingParkingSpotTest, Init) {
  ...
  StageApproachingParkingSpot stage(*stage_config_map_[stage_type_]);
