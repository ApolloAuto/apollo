...
class OpenSpaceRoiUtil {
 public:
  ...
  static void TransformByOriginPoint(const common::math::Vec2d& origin_point,
   ...
   */
  static bool LoadObstacles(const double filtering_distance,
   ...
   */
  static bool FilterOutObstacle(const double filtering_distance,
                                const Frame& frame,
                                const std::vector<double>& xy_boundary,
