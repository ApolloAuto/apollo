...
class CameraBevDetectionComponent
 ...
 private:
  ...
  std::shared_ptr<cyber::Reader<apollo::drivers::Image>> camf_reader_;
  std::shared_ptr<cyber::Reader<apollo::drivers::Image>> camfl_reader_;
  std::shared_ptr<cyber::Reader<apollo::drivers::Image>> camfr_reader_;
  std::shared_ptr<cyber::Reader<apollo::drivers::Image>> cambl_reader_;
  std::shared_ptr<cyber::Reader<apollo::drivers::Image>> cambr_reader_;
...
CYBER_REGISTER_COMPONENT(CameraBevDetectionComponent);
