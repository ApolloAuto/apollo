...
public:
    /**@brief Set the value of a pixel in the map, including all the resolution levels.
    ...
    /**@brief Given the 3D global coordinate, this function loads the
     * corresponding map node in the cache thread safely and return the value, if necessary.
     * This function returns the value of each layer in the map cell. */
