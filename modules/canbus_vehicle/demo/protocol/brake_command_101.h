...
class Brakecommand101
 ...
 public:
  ...
  // False, 'len': 16, 'name': 'Brake_Pedal_Target', 'offset': 0.0, 'order':
  ...
  // 'BRAKE_EN_CTRL_DISABLE', 1: 'BRAKE_EN_CTRL_ENABLE'}, 'is_signed_var':
  // False, 'len': 1, 'name': 'Brake_EN_CTRL', 'offset': 0.0, 'order':
 ...
 private:
  ...
  // 'Heartbeat_101', 'offset': 0.0, 'order': 'motorola', 'physical_range':
  // '[0|15]', 'physical_unit': '', 'precision': 1.0, 'type': 'int'}
  void set_p_heartbeat_101(uint8_t* data, int heartbeat_101);
  ...
  int heartbeat_101(const std::uint8_t* bytes, const int32_t length) const;
