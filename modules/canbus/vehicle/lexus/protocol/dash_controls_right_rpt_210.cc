...
void Dashcontrolsrightrpt210::set_p_output_value(uint8_t* data,
    Dash_controls_right_rpt_210::Output_valueType output_value) {
  int x = output_value;
...
void Dashcontrolsrightrpt210::set_p_commanded_value(uint8_t* data,
    Dash_controls_right_rpt_210::Commanded_valueType commanded_value) {
...
void Dashcontrolsrightrpt210::set_p_input_output_fault(uint8_t* data,
    bool input_output_fault) {
...
Dashcontrolsrightrpt210* Dashcontrolsrightrpt210::set_enabled(
    bool enabled) {
  enabled_ = enabled;
  return this;
 }
...
void Dashcontrolsrightrpt210::set_p_enabled(uint8_t* data,
    bool enabled) {
  int x = enabled;
...
void Dashcontrolsrightrpt210::set_p_command_output_fault(uint8_t* data,
    bool command_output_fault) {
...
void Dashcontrolsrightrpt210::set_p_manual_input(uint8_t* data,
    Dash_controls_right_rpt_210::Manual_inputType manual_input) {
  int x = manual_input;
