...
void Dashcontrolsrightcmd110::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_dash_controls_right_cmd_110()->set_ignore_overrides(ignore_overrides(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_right_cmd_110()->set_enable(enable(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_right_cmd_110()->set_clear_override(clear_override(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_right_cmd_110()->set_clear_faults(clear_faults(bytes, length));
  chassis->mutable_lexus()->mutable_dash_controls_right_cmd_110()->set_dash_controls_button(dash_controls_button(bytes, length));
}
...
// config detail: {'name': 'dash_controls_button', 'enum': {0: 'DASH_CONTROLS_BUTTON_DASH_CONTROL_NONE', 1: 'DASH_CONTROLS_BUTTON_DASH_CONTROL_OK', 2: 'DASH_CONTROLS_BUTTON_DASH_CONTROL_LEFT', 3: 'DASH_CONTROLS_BUTTON_DASH_CONTROL_RIGHT', 4: 'DASH_CONTROLS_BUTTON_DASH_CONTROL_UP', 5: 'DASH_CONTROLS_BUTTON_DASH_CONTROL_DOWN'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|255]', 'bit': 15, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
Dash_controls_right_cmd_110::Dash_controls_buttonType Dashcontrolsrightcmd110::dash_controls_button(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);

  Dash_controls_right_cmd_110::Dash_controls_buttonType ret =  static_cast<Dash_controls_right_cmd_110::Dash_controls_buttonType>(x);
  return ret;
}
}  // namespace lexus
}  // namespace canbus
