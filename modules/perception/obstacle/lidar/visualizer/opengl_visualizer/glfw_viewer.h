...
public:
    ...
    void set_frame_content(FrameContent* frame_content){_frame_content = frame_content;}
    void spin();
    void spin_once();
    void close();

    void set_background_color(Eigen::Vector3d i_bg_color) {_bg_color = i_bg_color;}
    void set_size(int w, int h);
    void set_camera_para(Eigen::Vector3d i_position, Eigen::Vector3d i_scn_center, Eigen::Vector3d i_up_vector);
    void set_forward_dir(Eigen::Vector3d forward){_forward_dir = forward;}
