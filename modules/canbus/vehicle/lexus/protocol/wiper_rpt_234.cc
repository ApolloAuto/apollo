...
void Wiperrpt234::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_vehicle_fault(vehicle_fault(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_pacmod_fault(pacmod_fault(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_override_active(override_active(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_output_reported_fault(output_reported_fault(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_input_output_fault(input_output_fault(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_enabled(enabled(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_command_output_fault(command_output_fault(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_output_value(output_value(bytes, length));
  chassis->mutable_lexus()->mutable_wiper_rpt_234()->set_commanded_value(commanded_value(bytes, length));
...
// config detail: {'name': 'output_value', 'enum': {0: 'OUTPUT_VALUE_WIPERS_OFF', 1: 'OUTPUT_VALUE_INTERMITTENT_1', 2: 'OUTPUT_VALUE_INTERMITTENT_2', 3: 'OUTPUT_VALUE_INTERMITTENT_3', 4: 'OUTPUT_VALUE_INTERMITTENT_4', 5: 'OUTPUT_VALUE_INTERMITTENT_5', 6: 'OUTPUT_VALUE_LOW', 7: 'OUTPUT_VALUE_HIGH'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|7]', 'bit': 31, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
Wiper_rpt_234::Output_valueType Wiperrpt234::output_value(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
...
// config detail: {'name': 'commanded_value', 'enum': {0: 'COMMANDED_VALUE_WIPERS_OFF', 1: 'COMMANDED_VALUE_INTERMITTENT_1', 2: 'COMMANDED_VALUE_INTERMITTENT_2', 3: 'COMMANDED_VALUE_INTERMITTENT_3', 4: 'COMMANDED_VALUE_INTERMITTENT_4', 5: 'COMMANDED_VALUE_INTERMITTENT_5', 6: 'COMMANDED_VALUE_LOW', 7: 'COMMANDED_VALUE_HIGH'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|7]', 'bit': 23, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
Wiper_rpt_234::Commanded_valueType Wiperrpt234::commanded_value(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
// config detail: {'name': 'manual_input', 'enum': {0: 'MANUAL_INPUT_WIPERS_OFF', 1: 'MANUAL_INPUT_INTERMITTENT_1', 2: 'MANUAL_INPUT_INTERMITTENT_2', 3: 'MANUAL_INPUT_INTERMITTENT_3', 4: 'MANUAL_INPUT_INTERMITTENT_4', 5: 'MANUAL_INPUT_INTERMITTENT_5', 6: 'MANUAL_INPUT_LOW', 7: 'MANUAL_INPUT_HIGH'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|7]', 'bit': 15, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
Wiper_rpt_234::Manual_inputType Wiperrpt234::manual_input(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
