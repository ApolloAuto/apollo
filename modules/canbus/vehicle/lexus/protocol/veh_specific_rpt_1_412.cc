...
void Vehspecificrpt1412::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_veh_specific_rpt_1_412()->set_shift_pos_2(shift_pos_2(bytes, length));
  chassis->mutable_lexus()->mutable_veh_specific_rpt_1_412()->set_shift_pos_1(shift_pos_1(bytes, length));
}
