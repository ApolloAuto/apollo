...
#include "modules/perception/camera_detection_3d/proto/camera_detection_3d.pb.h"
...
class CameraDetection3dComponent final
    : public cyber::Component<apollo::drivers::Image> {
 public:
  CameraDetection3dComponent() : timestamp_offset_(0) {}
  ~CameraDetection3dComponent() = default;
  /**
 ...
 private:
  bool InitObstacleDetector(const CameraDetection3d& detection_param);
  bool InitCameraFrame(const CameraDetection3d& detection_param);
  bool InitTransformWrapper(const CameraDetection3d& detection_param);
...
CYBER_REGISTER_COMPONENT(CameraDetection3dComponent);
