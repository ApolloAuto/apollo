 ...
 *****************************************************************************/
#ifndef MODULES_MAP_TOOLS_MAP_DATACHECKER_SERVER_LOOPS_VERIFY_AGENT_H
#define MODULES_MAP_TOOLS_MAP_DATACHECKER_SERVER_LOOPS_VERIFY_AGENT_H
#include <grpc++/grpc++.h>
#include <memory>
#include <utility>
#include <vector>
...
using LOOPS_VERIFY_REQUEST_TYPE = const apollo::hdmap::LoopsVerifyRequest;
...
class LoopsVerifyAgent {
 ...
 private:
  void StartVerify(LOOPS_VERIFY_REQUEST_TYPE *request,
                   LOOPS_VERIFY_RESPONSE_TYPE *response);
  void CheckVerify(LOOPS_VERIFY_REQUEST_TYPE *request,
                   LOOPS_VERIFY_RESPONSE_TYPE *response);
  void StopVerify(LOOPS_VERIFY_REQUEST_TYPE *request,
                  LOOPS_VERIFY_RESPONSE_TYPE *response);
...
#endif  // MODULES_MAP_TOOLS_MAP_DATACHECKER_SERVER_LOOPS_VERIFY_AGENT_H
