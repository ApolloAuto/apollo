...
Node3d::Node3d(
    ...
    x_grid_ = static_cast<int>((x_ - XYbounds[0]) / open_space_conf.warm_start_config().xy_grid_resolution());
    y_grid_ = static_cast<int>((y_ - XYbounds[2]) / open_space_conf.warm_start_config().xy_grid_resolution());
...
Node3d::Node3d(
    ...
    x_grid_ = static_cast<int>((x_ - XYbounds[0]) / warm_start_conf.xy_grid_resolution());
    y_grid_ = static_cast<int>((y_ - XYbounds[2]) / warm_start_conf.xy_grid_resolution());
    phi_grid_ = static_cast<int>((phi_ - (-M_PI)) / warm_start_conf.phi_grid_resolution());
...
Box2d Node3d::GetBoundingBox(
    ...
    Box2d ego_box({x + shift_distance * std::cos(phi), y + shift_distance * std::sin(phi)}, phi, ego_length, ego_width);
    return ego_box;
}
