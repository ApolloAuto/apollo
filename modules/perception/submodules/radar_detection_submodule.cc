 ...
 *****************************************************************************/
#include "modules/perception/submodules/radar_detection_submodule.h"
...
bool RadarDetectionSubmodule::Init() {
  RadarSubmoduleConfig comp_config;
  if (!GetProtoConfig(&comp_config)) {
    return false;
  }
  AINFO << "Radar Detection Submodule Configs: " << comp_config.DebugString();
...
bool RadarDetectionSubmodule::Proc(const std::shared_ptr<ContiRadar>& message) {
...
bool RadarDetectionSubmodule::InitAlgorithmPlugin() {
...
bool RadarDetectionSubmodule::InternalProc(
...
bool RadarDetectionSubmodule::GetCarLocalizationSpeed(
