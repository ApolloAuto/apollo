...
#include "modules/prediction/evaluator/model_manager/model/multi_agent_pedestrian_torch_gpu/multi_agent_pedestrian_torch_model.h"
...
bool MultiAgentPedestrianGpuTorch::Init() {
...
bool MultiAgentPedestrianGpuTorch::LoadModel() {
...
bool MultiAgentPedestrianGpuTorch::Inference(
...
void MultiAgentPedestrianGpuTorch::Destory() {}
