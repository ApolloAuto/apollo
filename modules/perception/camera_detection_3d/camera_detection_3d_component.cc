 ...
 *****************************************************************************/
#include "modules/perception/camera_detection_3d/camera_detection_3d_component.h"
...
#include "modules/perception/camera_detection_3d/detector/caddn/caddn_obstacle_detector.h"
#include "modules/perception/camera_detection_3d/detector/smoke/smoke_obstacle_detector.h"
...
bool CameraDetection3dComponent::InitObstacleDetector(
    const CameraDetection3d& detection_param) {
...
bool CameraDetection3dComponent::InitCameraFrame(
    const CameraDetection3d& detection_param) {
...
bool CameraDetection3dComponent::InitTransformWrapper(
    const CameraDetection3d& detection_param) {
...
bool CameraDetection3dComponent::Init() {
  CameraDetection3d detection_param;
...
void CameraDetection3dComponent::CameraToWorldCoor(
...
bool CameraDetection3dComponent::Proc(
...
bool CameraDetection3dComponent::InternalProc(
    const std::shared_ptr<apollo::drivers::Image>& msg,
