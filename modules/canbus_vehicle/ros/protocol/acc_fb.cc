...
double AccFb::acceleration_x(const std::uint8_t* bytes, const int32_t length) const {
  Byte t0(bytes + 0);
...
double AccFb::acceleration_y(const std::uint8_t* bytes, const int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
double AccFb::acceleration_z(const std::uint8_t* bytes, const int32_t length) const {
  Byte t0(bytes + 4);
  int32_t x = t0.get_byte(0, 8);
