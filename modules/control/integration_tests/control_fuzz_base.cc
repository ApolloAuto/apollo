...
uint32_t ControlFuzzBase::s_seq_num_ = 0;

bool ControlFuzzBase::test_control() {
...
void ControlFuzzBase::trim_control_command(ControlCommand *origin) {
...
bool ControlFuzzBase::test_control(const std::string &test_case_name,
                                   int case_num) {
...
void ControlFuzzBase::SetUpTestCase() {
  ros::Time::init();
