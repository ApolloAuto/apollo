...
GraphCreator::GraphCreator(const std::string& base_map_file_path,
        ...
        _base_map_file_path(base_map_file_path), _dump_topo_file_path(dump_topo_file_path) {
}

bool GraphCreator::create() {
    if (!::adu::routing::FileUtils::load_protobuf_data_from_file(_base_map_file_path, &_pbmap)) {
    ...
    if (!::adu::routing::FileUtils::dump_protobuf_data_to_file(_dump_topo_file_path, _graph)) {
