...
#include "modules/prediction_plugin/semantic_lstm_vehicle_tensorrt/semantic_lstm_vehicle_tensorrt.h"
...
bool SemanticLstmVehicleTensorrt::LoadModel() {
...
bool SemanticLstmVehicleTensorrt::Inference(
...
void SemanticLstmVehicleTensorrt::Destory() {
...
bool SemanticLstmVehicleTensorrt::Init() {
