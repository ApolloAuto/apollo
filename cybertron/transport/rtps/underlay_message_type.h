...
#ifndef CYBERTRON_TRANSPORT_RTPS_UNDERLAY_MESSAGE_TYPE_H_
#define CYBERTRON_TRANSPORT_RTPS_UNDERLAY_MESSAGE_TYPE_H_
...
#endif  // CYBERTRON_TRANSPORT_RTPS_UNDERLAY_MESSAGE_TYPE_H_
