...
class TrafficLightUnprotectedRightTurnStageStopTest : public ::testing::Test {
 public:
  virtual void SetUp() {
    config_.set_name("TRAFFIC_LIGHT_UNPROTECTED_RIGHT_TURN_CREEP");
...
TEST_F(TrafficLightUnprotectedRightTurnStageStopTest, Init) {
  TrafficLightUnprotectedRightTurnStageStop
      traffic_light_unprotected_right_turn_stage_stop;
  traffic_light_unprotected_right_turn_stage_stop.Init(
