...
#include "modules/perception/proto/traffic_light_submodule.pb.h"
...
class TrafficLightSubmodule : public apollo::cyber::Component<> {
 public:
  TrafficLightSubmodule() = default;
  ~TrafficLightSubmodule() = default;

  TrafficLightSubmodule(const TrafficLightSubmodule&) = delete;
  TrafficLightSubmodule& operator=(const TrafficLightSubmodule&) = delete;
...
CYBER_REGISTER_COMPONENT(TrafficLightSubmodule);
