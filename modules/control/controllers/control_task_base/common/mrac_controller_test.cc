...
#include "modules/control/controllers/control_task_base/proto/mrac_conf.pb.h"
...
class MracControllerTest : public ::testing::Test {
 public:
  virtual void SetUp() {
    ...
    ACHECK(cyber::common::GetProtoFromFile(
        control_conf_file, &lat_controller_conf_));
 ...
 protected:
  LatBaseLqrControllerConf lat_controller_conf_;
