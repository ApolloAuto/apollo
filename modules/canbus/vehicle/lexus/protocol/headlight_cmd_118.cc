...
Headlightcmd118* Headlightcmd118::set_ignore_overrides(
...
Headlightcmd118* Headlightcmd118::set_enable(
    bool enable) {
  enable_ = enable;
  return this;
 }
...
void Headlightcmd118::set_p_enable(uint8_t* data,
    bool enable) {
  int x = enable;
...
Headlightcmd118* Headlightcmd118::set_clear_override(
    bool clear_override) {
...
void Headlightcmd118::set_p_clear_override(uint8_t* data,
    bool clear_override) {
...
Headlightcmd118* Headlightcmd118::set_clear_faults(
    bool clear_faults) {
...
void Headlightcmd118::set_p_clear_faults(uint8_t* data,
    bool clear_faults) {
  int x = clear_faults;
...
// config detail: {'name': 'HEADLIGHT_CMD', 'enum': {0: 'HEADLIGHT_CMD_HEADLIGHTS_OFF', 1: 'HEADLIGHT_CMD_LOW_BEAMS', 2: 'HEADLIGHT_CMD_HIGH_BEAMS'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|2]', 'bit': 15, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
