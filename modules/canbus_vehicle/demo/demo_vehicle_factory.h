 ...
 * create controller and message manager for demo vehicle.
 */
class DemoVehicleFactory : public AbstractVehicleFactory {
 ...
 private:
  /**
   * @brief create demo vehicle controller
  ...
  /**
   * @brief create demo message manager
  ...
  apollo::drivers::canbus::CanReceiver<::apollo::canbus::Demo> can_receiver_;
  std::unique_ptr<MessageManager<::apollo::canbus::Demo>> message_manager_;
  std::unique_ptr<VehicleController<::apollo::canbus::Demo>>
      vehicle_controller_;

  std::shared_ptr<::apollo::cyber::Writer<::apollo::canbus::Demo>>
