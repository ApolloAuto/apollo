...
void Steeringmotorrpt3406::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_steering_motor_rpt_3_406()->set_torque_output(torque_output(bytes, length));
  chassis->mutable_lexus()->mutable_steering_motor_rpt_3_406()->set_torque_input(torque_input(bytes, length));
}
