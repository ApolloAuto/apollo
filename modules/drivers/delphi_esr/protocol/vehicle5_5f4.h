...
class Vehicle55f4 : public SensorProtocolData<DelphiESR> {
 public:
 ...
 private:
  ...
  Vehicle5_5f4::Can_rx_yaw_rate_bias_shiftType can_rx_yaw_rate_bias_shift(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_steering_gear_ratio(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_wheelbase(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_distance_rear_axle(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_cw_blockage_threshold(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_funnel_offset_right(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_funnel_offset_left(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_beamwidth_vert(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int can_rx_oversteer_understeer(const std::uint8_t* bytes, const int32_t length) const;
};
