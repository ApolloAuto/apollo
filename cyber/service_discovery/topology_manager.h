 ...
 * ChannelManager: You can find Channels in this topology, and their Writers and
 * Readers
 * ServiceManager: You can find Services in this topology, and their Servers and
 * Clients
 * TopologyManager use fast-rtps' Participant to communicate. It can broadcast
...
class TopologyManager {
 ...
 private:
  ...
  /**
   * @brief rtps participant to publish and subscribe
   */
  transport::ParticipantPtr participant_;
  ParticipantListener* participant_listener_;
  /**
   * @brief topology changing signal, connect to `ChangeFunc`s
   *
   */
