...
#ifndef BAIDU_MAPAUTO_NAVI_GUIDE_BDVIRTUALMAPVIEWINFO_H
#define BAIDU_MAPAUTO_NAVI_GUIDE_BDVIRTUALMAPVIEWINFO_H
...
/**
 * @brief This is the data class that holds the virtual map view information for IHRouteGuideViewListener.onVirtualMapViewUpdated
 * @details This class is available for Korea only
 * @author Sun Fengyan (sunfengyan@baidu.com)
 * @sa IHRouteGuideViewListener.onJunctionViewUpdated
 */
class BDVirtualMapViewInfo {
public:
    /**
     * @brief The constructor which should be initiated in order to use this class
     */     
    BDVirtualMapViewInfo();

    BDVirtualMapViewInfo(const common::BDGeoCoord& geoCoord,
     ...
     */
    BDVirtualMapViewInfo& operator=(const BDVirtualMapViewInfo& object);
    ...
    /**
     * @brief Get the id of virtual map
     * @retval id of element
     */
    BDUInt32 getId() const;

private:
    class BDVirtualMapViewInfoImpl;
    BDVirtualMapViewInfoImpl* m_pImpl;
};
...
#endif // BAIDU_MAPAUTO_NAVI_GUIDE_BDVIRTUALMAPVIEWINFO_H
