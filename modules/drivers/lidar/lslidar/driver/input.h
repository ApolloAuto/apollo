...
#ifndef LIDAR_LSLIDAR_SRC_INPUT_H_
#define LIDAR_LSLIDAR_SRC_INPUT_H_
...
class Input {
 public:
  ...
  //void getPacketTimeStamp(LslidarPacket &packet);
...
/** @brief lslidar input from PCAP dump file.
   ...
   */
    ...
    public:
        InputPCAP(uint16_t port = MSOP_DATA_PORT_NUMBER,std::string lidar_ip = "192.168.1.200", int packet_size = 1212, double packet_rate = 0.0,
