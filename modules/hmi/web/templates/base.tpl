...
<head>
  ...
  <script src="{{ url_for('static', filename='lib/jquery/3.2.1/jquery.min.js') }}"></script>
  <style>
    body {
...
<body>
  ...
  <script src="{{ url_for('static', filename='lib/bootstrap/3.3.7/js/bootstrap.min.js') }}"></script>
</body>
</html>
