...
Wipercmd134* Wipercmd134::set_ignore_overrides(
...
void Wipercmd134::set_p_ignore_overrides(uint8_t* data,
    bool ignore_overrides) {
...
Wipercmd134* Wipercmd134::set_enable(
    bool enable) {
  enable_ = enable;
  return this;
 }
...
void Wipercmd134::set_p_enable(uint8_t* data,
    bool enable) {
  int x = enable;
...
Wipercmd134* Wipercmd134::set_clear_override(
    bool clear_override) {
...
void Wipercmd134::set_p_clear_override(uint8_t* data,
    bool clear_override) {
...
Wipercmd134* Wipercmd134::set_clear_faults(
    bool clear_faults) {
...
void Wipercmd134::set_p_clear_faults(uint8_t* data,
    bool clear_faults) {
  int x = clear_faults;
