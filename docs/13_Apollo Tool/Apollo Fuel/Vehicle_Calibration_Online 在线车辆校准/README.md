...
3. Chinese version tailing for D-kit is available at [Vehicle_Calibration_Online_cn.md](https://github.com/ApolloAuto/apollo/blob/r7.0.0/docs/D-kit/Waypoint_Following/vehicle_calibration_online_cn.md)
