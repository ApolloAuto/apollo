...
void Aebrearwheelspeed354::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_aeb_rearwheelspeed_354()->set_wheelspeed_rl_valid(
      wheelspeed_rl_valid(bytes, length));
  chassis->mutable_aeb_rearwheelspeed_354()->set_wheelspeed_rl(
      wheelspeed_rl(bytes, length));
  chassis->mutable_aeb_rearwheelspeed_354()->set_wheelspeed_rr_valid(
      wheelspeed_rr_valid(bytes, length));
  chassis->mutable_aeb_rearwheelspeed_354()->set_wheelspeed_rr(
      wheelspeed_rr(bytes, length));
  chassis->mutable_aeb_rearwheelspeed_354()->set_wheelspeed_rl_direct(
      wheelspeed_rl_direct(bytes, length));
  chassis->mutable_aeb_rearwheelspeed_354()->set_wheelspeed_rr_direct(
      wheelspeed_rr_direct(bytes, length));
  chassis->mutable_aeb_rearwheelspeed_354()->set_alivecounter_rear(
      alivecounter_rear(bytes, length));
  chassis->mutable_aeb_rearwheelspeed_354()->set_checksum_rear(
