...
class MinibusController final : public VehicleController {
 public:
  MinibusController() {}

  virtual ~MinibusController();
 ...
 private:
  // control protocol
  Controllerparking18ff8ca9* controller_parking_18ff8ca9_ = nullptr;
  Controllerpedalcmd18ff84a9* controller_pedal_cmd_18ff84a9_ = nullptr;
  Controllerstatusrequset18ff86a9* controller_status_requset_18ff86a9_ =
      nullptr;
  Controllersteeringcmd18ff82a9* controller_steering_cmd_18ff82a9_ = nullptr;
