...
#ifndef MODULES_DRIVERS_SENSORS_CANBUS_H_
#define MODULES_DRIVERS_SENSORS_CANBUS_H_
...
class SensorCanbus : public apollo::common::ApolloApp {
 ...
 private:
  ...
  std::unique_ptr<SensorMessageManager<SensorType>> sensor_message_manager_;
