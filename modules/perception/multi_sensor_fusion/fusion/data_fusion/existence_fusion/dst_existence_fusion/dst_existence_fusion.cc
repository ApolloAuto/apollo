...
#include "modules/perception/multi_sensor_fusion/proto/dst_existence_fusion_config.pb.h"
...
bool DstExistenceFusion::Init(const ExistenceFusionInitOptions &options) {
...
void DstExistenceFusion::UpdateWithoutMeasurement(const std::string &sensor_id,
  ...
  if (algorithm::SensorManager::Instance()->IsCamera(sensor_id)) {
