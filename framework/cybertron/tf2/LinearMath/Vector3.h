...
#ifndef CYBERTRON_TF2_LINEARMATH_VECTOR3_H_
#define CYBERTRON_TF2_LINEARMATH_VECTOR3_H_
 ...
 * Ideally, this class should be replaced by a platform optimized TF2SIMD
 * version that keeps the data in registers
 */
ATTRIBUTE_ALIGNED16(class) Vector3 {
 ...
 public:
  ...
  TF2SIMD_FORCE_INLINE Vector3
      rotate(const Vector3 & wAxis, const tf2Scalar angle) const;
  ...
  /**@brief Return the ccybertrons product between this and another vector
   * @param v The other vector */
  TF2SIMD_FORCE_INLINE Vector3 ccybertrons(const Vector3 & v) const {
...
*/
  ...
  TF2SIMD_FORCE_INLINE void deSerializeFloat(const struct Vector3FloatData &
                                             dataIn);

  TF2SIMD_FORCE_INLINE void serializeDouble(struct Vector3DoubleData & dataOut)
      const;

  TF2SIMD_FORCE_INLINE void deSerializeDouble(const struct Vector3DoubleData &
                                              dataIn);
};
...
/**@brief Return the ccybertrons product of two vectors */
TF2SIMD_FORCE_INLINE Vector3
tf2Ccybertrons(const Vector3& v1, const Vector3& v2) {
  return v1.ccybertrons(v2);
}
...
/// ccybertrons-platform serialization
...
#endif  // INCLUDE_CYBERTRON_TF2_LINEARMATH_VECTOR3_H_
