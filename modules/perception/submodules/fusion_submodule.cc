 ...
 *****************************************************************************/
#include "modules/perception/submodules/fusion_submodule.h"

#include "cyber/time/clock.h"
#include "modules/common/util/perf_util.h"
#include "modules/perception/base/object_pool_types.h"
#include "modules/perception/submodules/common_flags.h"
#include "modules/perception/submodules/msg_serializer.h"

namespace apollo {
namespace perception {

uint32_t FusionSubmodule::s_seq_num_ = 0;
std::mutex FusionSubmodule::s_mutex_;

bool FusionSubmodule::Init() {
  FusionSubmoduleConfig comp_config;
  if (!GetProtoConfig(&comp_config)) {
    return false;
  }
  AINFO << "Fusion Submodule Configs: " << comp_config.DebugString();

  // to load submodule configs
...
bool FusionSubmodule::Proc(const std::shared_ptr<SensorFrameMessage>& message) {
...
bool FusionSubmodule::InitAlgorithmPlugin() {
  ...
  AINFO << "Init algorithm successfully, submodule fusion: " << fusion_method_;
  return true;
}

bool FusionSubmodule::InternalProc(
