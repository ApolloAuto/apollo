...
void callback(const std_msgs::Int16::ConstPtr& msg) {
    is_saving = (msg->data == 3 || msg->data == 4);
}
...
int main(int argc, char** argv) {
  ...
  ros::init(argc, argv, "rear_camera");
  ros::NodeHandle n;
  ros::Rate rate(20);
  ...
  ProgramArguments g_arguments(
  {
      ...
      ProgramArguments::Option_t("csi-port", "cd"),
  ...
  image_publisher = n.advertise<sensor_msgs::Image>("/car_msgs/rear_image", 10);
  std_msgs::Bool save_st;
  ros::Publisher saving_image_pub = n.advertise<std_msgs::Bool>("/data/saving_rear_image", 10); 
