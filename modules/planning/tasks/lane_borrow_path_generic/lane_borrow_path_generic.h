...
#include "modules/planning/tasks/lane_borrow_path_generic/proto/lane_borrow_path_generic.pb.h"
...
private:
    ...
    bool GetBoundaryFromNudgeDecision(const SidePassDirection pass_direction, PathBoundary* const path_bound);
    ...
    bool IsEnableNudge(const ReferenceLineInfo& reference_line_info);
    ...
    void GetSLPolygons(std::vector<SLPolygon>* polygons, LaneBorrowInfo lane_borrow_info);
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::planning::LaneBorrowPathGeneric, Task)
}  // namespace planning
}  // namespace apollo
