...
std::vector<SpeedPoint> LaneFollowScenario::GenerateInitSpeedProfile(
...
std::vector<SpeedPoint> LaneFollowScenario::GenerateSpeedHotStart(
    const TrajectoryPoint& planning_init_point) {
...
SpeedData LaneFollowScenario::GenerateFallbackSpeedProfile(
    const ReferenceLineInfo& reference_line_info) {
...
SpeedData LaneFollowScenario::GenerateStopProfile(const double init_speed,
...
SpeedData LaneFollowScenario::GenerateStopProfileFromPolynomial(
...
bool LaneFollowScenario::IsValidProfile(
