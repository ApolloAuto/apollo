...
bool ExternalFeatureExtractor::Init(const FeatureExtractorInitOptions
  ...
  inference_.reset(inference::CreateInferenceByName(model_type,
                                                    proto_file,
                                                    weight_file,
                                                    output_names,
                                                    input_names,
  ...
  std::map<std::string, std::vector<int>>
      shape_map{{param_.input_blob(), shape}};
...
bool ExternalFeatureExtractor::InitFeatureExtractor(const std::string
                                                    &root_dir) {
...
bool ExternalFeatureExtractor::Extract(const FeatureExtractorOptions &options,
  ...
  feature_extractor_->set_roi(image_options.crop_roi.x,
                              image_options.crop_roi.y,
