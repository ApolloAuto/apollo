...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_SHIFT_RPT_228_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_SHIFT_RPT_228_H_
...
class Shiftrpt228 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Shift_rpt_228::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Shift_rpt_228::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Shift_rpt_228::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_SHIFT_RPT_228_H_
