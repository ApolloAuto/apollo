...
class StageSlowDownTest : public ::testing::Test {
 public:
  virtual void SetUp() {
    config_.set_name("EMERGENCY_PULL_OVER_SLOW_DOWN");
...
TEST_F(StageSlowDownTest, Init) {
  EmergencyPullOverStageSlowDown emergency_pull_over_stage_slow_down;
  emergency_pull_over_stage_slow_down.Init(
