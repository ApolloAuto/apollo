...
DEFINE_string(base_map_dir, "/home/caros/adu_data/map", "directory of base map");
DEFINE_string(base_map_name, "base_map.bin", "file name of base map");
DEFINE_string(dump_topo_path, "/home/fuxiaoxin/Desktop/routing_map.bin", "dump path of routing topology file");
