...
void Datetimerpt40f::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_lexus()->mutable_date_time_rpt_40f()->set_time_second(time_second(bytes, length));
  chassis->mutable_lexus()->mutable_date_time_rpt_40f()->set_time_minute(time_minute(bytes, length));
