...
#ifndef CYBERTRON_PARAMETER_PARAMETER_CLIENT_H_
#define CYBERTRON_PARAMETER_PARAMETER_CLIENT_H_

#include <memory>
#include <string>
#include <vector>
#include "cybertron/parameter/parameter.h"
...
class ParameterClient {
 public:
  using Param = apollo::cybertron::proto::Param;
  using NodeName = apollo::cybertron::proto::NodeName;
  using ParamName = apollo::cybertron::proto::ParamName;
  using BoolResult = apollo::cybertron::proto::BoolResult;
  using Params = apollo::cybertron::proto::Params;
...
#endif  // CYBERTRON_PARAMETER_PARAMETER_CLIENT_H_
