...
#include "modules/drivers/lidar_velodyne/pointcloud/pointcloud_dump.h"
...
PointCloudDump::PointCloudDump(ros::NodeHandle node,
  ...
  pointcloud_sub_ =
      node.subscribe(topic_name_, 1000, &PointCloudDump::save_callback,
                     reinterpret_cast<PointCloudDump *>(this),
