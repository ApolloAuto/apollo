...
#include "modules/canbus/vehicle/ch/protocol/vin_resp2_51c.h"
...
void Vinresp251c::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin16(
      vin16(bytes, length));
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin15(
      vin15(bytes, length));
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin14(
      vin14(bytes, length));
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin13(
      vin13(bytes, length));
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin12(
      vin12(bytes, length));
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin11(
      vin11(bytes, length));
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin10(
      vin10(bytes, length));
  chassis->mutable_ch()->mutable_vin_resp2_51c()->set_vin09(
      vin09(bytes, length));
}
...
// 'int'}
int Vinresp251c::vin16(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
...
// 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'int'}
int Vinresp251c::vin15(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'int'}
int Vinresp251c::vin14(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'int'}
int Vinresp251c::vin13(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 4);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'int'}
int Vinresp251c::vin12(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'int'}
int Vinresp251c::vin11(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'int'}
int Vinresp251c::vin10(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
...
// 'physical_range': '[0|0]', 'physical_unit': '', 'precision': 1.0, 'type':
// 'int'}
int Vinresp251c::vin09(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(0, 8);
