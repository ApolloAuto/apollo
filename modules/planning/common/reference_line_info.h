...
class ReferenceLineInfo {
 public:
  ...
  mutable_path_point_decision_guide() {
    return &path_point_decision_guide_;
  }
 ...
 private:
   ...
   * @param tuple consists of s axis position; cut_in_lane, out_lane and
   * back_in_lane enum; distance to closest obstacle
   */
  // TODO(Jiacheng) change double to enum
  std::vector<std::tuple<double, double, double>> path_point_decision_guide_;
