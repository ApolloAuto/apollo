 ...
 *****************************************************************************/
#ifndef PERCEPTION_LIDAR_LIB_TRACKER_COMMON_TRACKED_OBJECT_H_
#define PERCEPTION_LIDAR_LIB_TRACKER_COMMON_TRACKED_OBJECT_H_
...
struct TrackedObject {
  ...
  void Reset();
  void Reset(base::ObjectPtr obj_ptr, const Eigen::Affine3d& pose);
  // void Clone(const TrackedObject& rhs);
  std::string ToString() const;
  void ComputeShapeFeatures();
  void AttachObject(base::ObjectPtr obj_ptr, const Eigen::Affine3d& pose);

  void CopyFrom(std::shared_ptr<TrackedObject> rhs, bool is_deep);

  void ToObject(base::ObjectPtr obj_ptr);
...
#endif  // PERCEPTION_LIDAR_LIB_TRACKER_HM_TRACKER_TRACKED_OBJECT_H_
