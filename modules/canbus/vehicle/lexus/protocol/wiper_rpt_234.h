...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_WIPER_RPT_234_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_WIPER_RPT_234_H_
...
class Wiperrpt234 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Wiper_rpt_234::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Wiper_rpt_234::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Wiper_rpt_234::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_WIPER_RPT_234_H_
