 ...
 *****************************************************************************/
#include "modules/perception/common/lib/calibration_service/online_calibration_service/online_calibration_service.h"
...
bool OnlineCalibrationService::QueryDepthOnGroundPlane(int x, int y,
  ...
  bool success = algorithm::IBackprojectPlaneIntersectionCanonical(
...
void OnlineCalibrationService::Update(onboard::CameraFrame *frame) {
  if (frame == nullptr) {
