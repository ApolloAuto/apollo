...
class Ultrsensor4510
 ...
 private:
  ...
  // 'uiUSS5_ToF_Indirect', 'offset': 0.0, 'order': 'motorola',
  ...
  // 'uiUSS4_ToF_Indirect', 'offset': 0.0, 'order': 'motorola',
  // 'physical_range': '[0|65535]', 'physical_unit': 'cm', 'precision': 0.01724,
  // 'type': 'double'}
  ...
  // 'uiUSS3_ToF_Indirect', 'offset': 0.0, 'order': 'motorola',
  // 'physical_range': '[0|65535]', 'physical_unit': 'cm', 'precision': 0.01724,
  // 'type': 'double'}
  ...
  // 'uiUSS2_ToF_Indirect', 'offset': 0.0, 'order': 'motorola',
  // 'physical_range': '[0|65535]', 'physical_unit': 'cm', 'precision': 0.01724,
  // 'type': 'double'}
