...
#ifndef CYBERTRON_TOPOLOGY_COMMUNICATION_PARTICIPANT_LISTENER_H_
#define CYBERTRON_TOPOLOGY_COMMUNICATION_PARTICIPANT_LISTENER_H_
...
#endif  // CYBERTRON_TOPOLOGY_COMMUNICATION_PARTICIPANT_LISTENER_H_
