...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_TURN_RPT_230_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_TURN_RPT_230_H_
...
class Turnrpt230 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Turn_rpt_230::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Turn_rpt_230::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Turn_rpt_230::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_TURN_RPT_230_H_
