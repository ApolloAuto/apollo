...
#include "modules/perception/lidar_segmentation/segmentor/ncut_segmentation/common/graph_felzenszwalb/convolve.h"
#include "modules/perception/lidar_segmentation/segmentor/ncut_segmentation/common/graph_felzenszwalb/image.h"
#include "modules/perception/lidar_segmentation/segmentor/ncut_segmentation/common/graph_felzenszwalb/imconv.h"
...
/**
 * @brief Normalize mask so it integrates to one
 *
 * @param mask_input
 */
...
/**
 * @brief Convolve image with gaussian filter
 *
 * @param src
 * @param sigma
 * @return Image<float>*
