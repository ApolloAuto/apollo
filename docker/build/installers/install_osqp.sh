...
DOWNLOAD_LINK="https://apollo-platform-system.bj.bcebos.com/archive/6.0/v${OSQP_VER}.tar.gz"
...
pushd "osqp-${OSQP_VER}"
    ...
    DOWNLOAD_LINK="https://apollo-platform-system.bj.bcebos.com/archive/6.0/v0.1.4.tar.gz"
