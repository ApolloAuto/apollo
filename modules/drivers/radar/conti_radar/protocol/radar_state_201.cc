...
RadarState_201::OutputType RadarState201::output_type(const std::uint8_t* bytes,
                                      int32_t length) const {
  Byte t0(bytes + 5);
  ...
  switch (x) {
    case 0x0:
      return RadarState_201::OUTPUT_TYPE_NONE;
    case 0x1:
      return RadarState_201::OUTPUT_TYPE_OBJECTS;
    case 0x2:
      return RadarState_201::OUTPUT_TYPE_CLUSTERS;
    default:
      return RadarState_201::OUTPUT_TYPE_ERROR;
  }
}

RadarState_201::RcsThreshold RadarState201::rcs_threshold(
  ...
  switch (x) {
    case 0x0:
      return RadarState_201::RCS_THRESHOLD_STANDARD;
    case 0x1:
      return RadarState_201::RCS_THRESHOLD_HIGH_SENSITIVITY;
    default:
      return RadarState_201::RCS_THRESHOLD_ERROR;
  }
}
