...
#ifndef CYBERTRON_MESSAGE_PROTOBUF_FACTORY_H_
#define CYBERTRON_MESSAGE_PROTOBUF_FACTORY_H_
...
using apollo::cybertron::proto::ProtoDesc;
...
#endif  // CYBERTRON_MESSAGE_PROTOBUF_FACTORY_H_
