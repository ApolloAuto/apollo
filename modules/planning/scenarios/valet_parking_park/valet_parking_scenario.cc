...
bool ValetParkingParkScenario::Init(std::shared_ptr<DependencyInjector> injector,
  ...
  if (!Scenario::LoadConfig<ScenarioValetParkingParkConfig>(
...
bool ValetParkingParkScenario::SearchTargetParkingSpotOnPath(
