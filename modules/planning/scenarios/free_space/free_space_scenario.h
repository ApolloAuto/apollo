...
#include "modules/planning/scenarios/free_space/proto/free_space_scenario.pb.h"
...
public:
     ...
     */
    FreeSpaceContext* GetContext() override {
        return &context_;
    }
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::planning::FreeSpaceScenario, Scenario)
