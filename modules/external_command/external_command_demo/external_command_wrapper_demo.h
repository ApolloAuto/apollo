...
class ExternalCommandWrapperDemo final : public apollo::cyber::TimerComponent {
 public:
  ExternalCommandWrapperDemo();
 ...
 private:
  ...
  std::shared_ptr<
      apollo::common::ClientWrapper<apollo::external_command::ChassisCommand,
                                    apollo::external_command::CommandStatus>>
  ...
  std::shared_ptr<
      apollo::common::ClientWrapper<apollo::external_command::PathFollowCommand,
                                    apollo::external_command::CommandStatus>>
      path_follow_command_client_;
  std::shared_ptr<
      apollo::common::ClientWrapper<apollo::external_command::SpeedCommand,
                                    apollo::external_command::CommandStatus>>
