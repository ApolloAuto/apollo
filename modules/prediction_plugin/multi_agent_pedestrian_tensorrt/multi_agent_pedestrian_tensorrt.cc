...
#include "modules/prediction_plugin/multi_agent_pedestrian_tensorrt/multi_agent_pedestrian_tensorrt.h"
...
bool MultiAgentPedestrianTensorrt::LoadModel() {
...
bool MultiAgentPedestrianTensorrt::Inference(
...
void MultiAgentPedestrianTensorrt::Destory() {
...
bool MultiAgentPedestrianTensorrt::Init() {
