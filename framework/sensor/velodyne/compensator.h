...
class Compensator {
 public:
   ...
   */
  bool motion_compensation(const std::shared_ptr<const proto::PointCloud>& msg,
 ...
 private:
  ...
  bool query_pose(const uint64_t& timestamp, void* pose,
                  const std::string& child_frame_id,
   ...
   */
  void motion_compensation(const std::shared_ptr<const proto::PointCloud>& msg,
                           std::shared_ptr<proto::PointCloud>& msg_compensated,
