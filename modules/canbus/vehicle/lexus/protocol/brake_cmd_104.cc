...
Brakecmd104* Brakecmd104::set_ignore_overrides(
...
void Brakecmd104::set_p_ignore_overrides(uint8_t* data,
    bool ignore_overrides) {
...
Brakecmd104* Brakecmd104::set_enable(
    bool enable) {
  enable_ = enable;
  return this;
 }
...
void Brakecmd104::set_p_enable(uint8_t* data,
    bool enable) {
  int x = enable;
...
Brakecmd104* Brakecmd104::set_clear_override(
    bool clear_override) {
...
void Brakecmd104::set_p_clear_override(uint8_t* data,
    bool clear_override) {
...
Brakecmd104* Brakecmd104::set_clear_faults(
    bool clear_faults) {
...
void Brakecmd104::set_p_clear_faults(uint8_t* data,
    bool clear_faults) {
  int x = clear_faults;
...
Brakecmd104* Brakecmd104::set_brake_cmd(
    double brake_cmd) {
  brake_cmd_ = brake_cmd;
  return this;
 }

// config detail: {'name': 'BRAKE_CMD', 'offset': 0.0, 'precision': 0.001, 'len': 16, 'is_signed_var': False, 'physical_range': '[0|1]', 'bit': 15, 'type': 'double', 'order': 'motorola', 'physical_unit': ''}
void Brakecmd104::set_p_brake_cmd(uint8_t* data,
    double brake_cmd) {
