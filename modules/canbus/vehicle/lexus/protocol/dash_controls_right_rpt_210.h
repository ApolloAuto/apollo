...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_DASH_CONTROLS_RIGHT_RPT_210_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_DASH_CONTROLS_RIGHT_RPT_210_H_
...
class Dashcontrolsrightrpt210 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  // config detail: {'name': 'OUTPUT_VALUE', 'enum': {0: 'OUTPUT_VALUE_DASH_CONTROL_NONE', 1: 'OUTPUT_VALUE_DASH_CONTROL_OK', 2: 'OUTPUT_VALUE_DASH_CONTROL_LEFT', 3: 'OUTPUT_VALUE_DASH_CONTROL_RIGHT', 4: 'OUTPUT_VALUE_DASH_CONTROL_UP', 5: 'OUTPUT_VALUE_DASH_CONTROL_DOWN'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|255]', 'bit': 31, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
  void set_p_output_value(uint8_t* data, Dash_controls_right_rpt_210::Output_valueType output_value);

  // config detail: {'name': 'COMMANDED_VALUE', 'enum': {0: 'COMMANDED_VALUE_DASH_CONTROL_NONE', 1: 'COMMANDED_VALUE_DASH_CONTROL_OK', 2: 'COMMANDED_VALUE_DASH_CONTROL_LEFT', 3: 'COMMANDED_VALUE_DASH_CONTROL_RIGHT', 4: 'COMMANDED_VALUE_DASH_CONTROL_UP', 5: 'COMMANDED_VALUE_DASH_CONTROL_DOWN'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|255]', 'bit': 23, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
  void set_p_commanded_value(uint8_t* data, Dash_controls_right_rpt_210::Commanded_valueType commanded_value);
  ...
  // config detail: {'name': 'MANUAL_INPUT', 'enum': {0: 'MANUAL_INPUT_DASH_CONTROL_NONE', 1: 'MANUAL_INPUT_DASH_CONTROL_OK', 2: 'MANUAL_INPUT_DASH_CONTROL_LEFT', 3: 'MANUAL_INPUT_DASH_CONTROL_RIGHT', 4: 'MANUAL_INPUT_DASH_CONTROL_UP', 5: 'MANUAL_INPUT_DASH_CONTROL_DOWN'}, 'precision': 1.0, 'len': 8, 'is_signed_var': False, 'offset': 0.0, 'physical_range': '[0|255]', 'bit': 15, 'type': 'enum', 'order': 'motorola', 'physical_unit': ''}
  void set_p_manual_input(uint8_t* data, Dash_controls_right_rpt_210::Manual_inputType manual_input);
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_DASH_CONTROLS_RIGHT_RPT_210_H_
