...
#include "modules/canbus/vehicle/esr/protocol/esr_status5_5e4.h"
...
int Esrstatus55e4::can_tx_supply_10v_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 7);
...
int Esrstatus55e4::can_tx_temp2_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(0, 8);
...
int Esrstatus55e4::can_tx_temp1_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 2);
  int32_t x = t0.get_byte(0, 8);
...
int Esrstatus55e4::can_tx_swbatt_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(0, 8);
...
int Esrstatus55e4::can_tx_supply_5vdx_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
  int32_t x = t0.get_byte(0, 8);
...
int Esrstatus55e4::can_tx_supply_5va_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 4);
  int32_t x = t0.get_byte(0, 8);
...
int Esrstatus55e4::can_tx_supply_3p3v_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
  int32_t x = t0.get_byte(0, 8);
...
int Esrstatus55e4::can_tx_ignp_a2d(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 8);
