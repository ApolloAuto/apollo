 ...
 * @file
 */
#include "modules/planning/planning_open_space/trajectory_smoother/distance_approach_ipopt_fixed_dual_interface.h"
namespace apollo {
namespace planning {
...
bool DistanceApproachIPOPTFixedDualInterface::eval_f(int n, const double* x, bool new_x, double& obj_value) {
    eval_obj(n, x, &obj_value);
    return true;
}

bool DistanceApproachIPOPTFixedDualInterface::eval_grad_f(int n, const double* x, bool new_x, double* grad_f) {
    gradient(tag_f, n, x, grad_f);
    return true;
}

bool DistanceApproachIPOPTFixedDualInterface::eval_g(int n, const double* x, bool new_x, int m, double* g) {
...
bool DistanceApproachIPOPTFixedDualInterface::check_g(int n, const double* x, int m, const double* g) {
    int kN = n;
    int kM = m;
    double x_u_tmp[kN];
    double x_l_tmp[kN];
...
void DistanceApproachIPOPTFixedDualInterface::generate_tapes(int n, int m, int* nnz_jac_g, int* nnz_h_lag) {
