...
class StopSignUnprotectedStageCreepTest : public StageTestBase {
 public:
  virtual void SetUp() {
    scenario_config_file_ = FLAGS_scenario_stop_sign_unprotected_config_file;
    stage_type_ = ScenarioConfig::STOP_SIGN_UNPROTECTED_CREEP;
    StageTestBase::SetUp();
  }
};
...
TEST_F(StopSignUnprotectedStageCreepTest, Init) {
  ...
  StopSignUnprotectedStageCreep stage(*stage_config_map_[stage_type_]);
