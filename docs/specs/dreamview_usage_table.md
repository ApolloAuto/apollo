...
| ![](images/dreamview_usage_table/0clip_image004.png) | <ul><li>The wheel steering percentage.</li> <li>The status of left/right turn signals (for emergency situation, both signals will be on.)</li></ul> |
...
| ![](images/dreamview_usage_table/0clip_image006.png) | <ul><li>The driving speed in km/h as default. Click the unit to change the unit.</li> <li>The accelerator/brake percentage</li></ul> |
