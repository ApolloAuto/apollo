...
void RadarConfig200::Reset() {
  ...
  radar_conf_.set_output_type(RadarState_201::OUTPUT_TYPE_NONE);
  ...
  radar_conf_.set_rcs_threshold(RadarState_201::RCS_THRESHOLD_STANDARD);
}
...
void RadarConfig200::set_output_type_p(
    uint8_t* data, RadarState_201::OutputType type) {
  Byte frame(data + 4);
...
void RadarConfig200::set_rcs_threshold_p(
    uint8_t* data, RadarState_201::RcsThreshold rcs_threshold) {
  Byte frame(data + 6);
