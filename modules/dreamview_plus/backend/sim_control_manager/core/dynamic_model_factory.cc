...
#include "modules/dreamview_plus/backend/sim_control_manager/proto/dynamic_model_conf.pb.h"
...
#include "modules/dreamview_plus/backend/sim_control_manager/dynamic_model/perfect_control/sim_perfect_control.h"
