...
function parseString(valueInString) {
    ...
    try {
        ...
        console.warn(`Failed to parse string ${valueInString}.`, 'Set its value without parsing.');
        value = valueInString;
    }
...
export function parseChartDataFromProtoBuf(protobuf) {
    const legendDisplay = typeof protobuf.options.legendDisplay === 'boolean' ? protobuf.options.legendDisplay : true;
    const options = {
        legend: {
