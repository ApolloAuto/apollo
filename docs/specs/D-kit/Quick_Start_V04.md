...
**客户车辆铭牌编号为：酷黑2019001~2019016的车辆请参考文档**https://github.com/coolhigh/apollo/blob/r3.0.0/docs/specs/Development_Kits/Quick_Start_V01.md

**客户车辆铭牌编号为：酷黑2019017-2019050的车辆请参考文档****https://github.com/coolhigh/apollo/blob/r3.0.0/docs/specs/Development_Kits/Quick_Start_V02.md

**客户车辆铭牌编号为：酷黑2019051-2019090的车辆请参考文档****https://github.com/ApolloAuto/apollo/blob/r5.5.0/docs/specs/D-kit/Quick_Start_V03.md
...
![CanLine_3.png](images/CanLine_3.png.png)
...
![remote control_2](images/remote_control_9.png)
