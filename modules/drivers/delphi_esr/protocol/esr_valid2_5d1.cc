...
#include "modules/canbus/vehicle/esr/protocol/esr_valid2_5d1.h"
...
void Esrvalid25d1::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_esr()->mutable_esr_valid2_5d1()->set_can_tx_valid_mr_sn(can_tx_valid_mr_sn(bytes, length));
  chassis->mutable_esr()->mutable_esr_valid2_5d1()->set_can_tx_valid_mr_range_rate(can_tx_valid_mr_range_rate(bytes, length));
  chassis->mutable_esr()->mutable_esr_valid2_5d1()->set_can_tx_valid_mr_range(can_tx_valid_mr_range(bytes, length));
  chassis->mutable_esr()->mutable_esr_valid2_5d1()->set_can_tx_valid_mr_power(can_tx_valid_mr_power(bytes, length));
  chassis->mutable_esr()->mutable_esr_valid2_5d1()->set_can_tx_valid_mr_angle(can_tx_valid_mr_angle(bytes, length));
}
