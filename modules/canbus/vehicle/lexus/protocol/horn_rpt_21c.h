...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_HORN_RPT_21C_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_HORN_RPT_21C_H_
...
class Hornrpt21c : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Horn_rpt_21c::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Horn_rpt_21c::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Horn_rpt_21c::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_HORN_RPT_21C_H_
