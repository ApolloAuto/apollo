...
class Bmsdatafeedback361 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  double bms_battery_temperature(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double bms_battery_current(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double bms_battery_voltage(const std::uint8_t* bytes, const int32_t length) const;
