...
class MultiAgentVehicleGpuTorch : public ModelBase {
 public:
  /**
   * @brief constructor
   */
  ...
  /**
   * @brief Destroy the Multi Agent Vehicle Gpu Torch object
   * 
   */
  ~MultiAgentVehicleGpuTorch() {Destory();}
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
  apollo::prediction::MultiAgentVehicleGpuTorch, ModelBase)
