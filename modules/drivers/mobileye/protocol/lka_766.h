...
/**
 * @file lka_766.h
 * @brief the class of 766 (for mobileye)
 */

#ifndef MODULES_DRIVERS_MOBILEYE_PROTOCOL_LKA_766_H
#define MODULES_DRIVERS_MOBILEYE_PROTOCOL_LKA_766_H
...
class Lka766 : public ::apollo::drivers::canbus::ProtocolData<Mobileye> {
 public:
  static const int ID;
  ...
  // 'physical_unit': '"m"'}
  double width_left_marking(const uint8_t* bytes, int32_t length) const;
};
...
#endif  // MODULES_DRIVERS_MOBILEYE_PROTOCOL_LKA_766_H
