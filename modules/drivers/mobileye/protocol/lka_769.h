...
/**
 * @file lka_769.h
 * @brief the class of 769 (for mobileye)
 */

#ifndef MODULES_DRIVERS_MOBILEYE_PROTOCOL_LKA_769_H
#define MODULES_DRIVERS_MOBILEYE_PROTOCOL_LKA_769_H
...
class Lka769 : public ::apollo::drivers::canbus::ProtocolData<Mobileye> {
 public:
  static const int ID;
...
#endif  // MODULES_DRIVERS_MOBILEYE_PROTOCOL_LKA_769_H
