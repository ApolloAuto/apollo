...
class Dashcontrolsleftrpt20c : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Dash_controls_left_rpt_20c::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Dash_controls_left_rpt_20c::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Dash_controls_left_rpt_20c::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
