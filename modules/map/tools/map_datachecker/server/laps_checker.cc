...
double LapsChecker::get_progress() const { return progress_; }

size_t LapsChecker::get_lap() const { return lap_; }
...
ErrorCode LapsChecker::get_return_state() { return return_state_; }
