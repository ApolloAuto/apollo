...
#ifndef CYBERTRON_TRANSPORT_QOS_QOS_PROFILE_CONF_H_
#define CYBERTRON_TRANSPORT_QOS_QOS_PROFILE_CONF_H_
...
using cybertron::proto::QosDurabilityPolicy;
using cybertron::proto::QosHistoryPolicy;
using cybertron::proto::QosProfile;
using cybertron::proto::QosReliabilityPolicy;
...
#endif  // CYBERTRON_TRANSPORT_QOS_QOS_PROFILE_CONF_H_
