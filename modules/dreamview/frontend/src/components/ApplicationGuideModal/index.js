...
class ApplicationGuideModal extends React.Component {
  ...
  componentDidMount() {
    // 排除实训平台下启动dreamview情况
    if (window.location.href.indexOf('practical/project') === -1) {
      this.enterAnimate();
    }
  }
  ...
  render() {
    ...
    return (
      <div className="application-guide-modal">
        ...
        <div className={classnames(['application-guide-modal-content', classes])}>
          ...
          <div className='application-guide-modal-content-body'>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <ul>
                      <li>
                        请在封闭区域运行此产品，请勿在公共道路、机动车道或高速公路行驶
                      </li>
                      <li>
                        可以对其它交通参与者的数量及行为进行管制的非公开道路
                      </li>
                    </ul>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <ul>
                      <li>
                        在水平（坡度小于1%）、干燥、具有良好附着力的混凝土或沥青路面
                      </li>
                      <li>
                        道路宽度不低于3.2m，最大曲率半径不低于1/0.172 m
                      </li>
                    </ul>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <ul>
                      ...
                      <li>
                        避免行人过于密集，避免高频出现突然横穿马路，快速奔跑，试探自动驾驶车辆等危险行为
                      </li>
                    </ul>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <ul>
                      <li>
                        无低矮障碍物（在车辆前方1m内的30cm以下障碍物）
                      </li>
                      <li>
                        无悬空障碍物（悬空细长型或镂空形的障碍物）
                      </li>
                      <li>
                        无悬空离地2m以下障碍物
                      </li>
            ...
            <ul>
              <li>
                在使用本产品之前请详细阅读D-KIT使用说明书或参加相关培训，严禁将车辆交予未经操作培训的人员独自操作使用。
              </li>
              <li>
                车辆不能在完全脱离人员监管的情况下使用，禁止在超出本产品使用范围的环境条件下使用本产品。
              </li>
              <li>
                使用车辆前，请目视检查车胎是否损坏、充气压力是否合适以及胎纹内是否嵌入异物，必要时采取校正措施；检查车辆下部是否有泄露液体或易燃物。
              </li>
              <li>
                启动车辆前，检查上电开关接通时各项指示灯的工作状况；遥控车辆及自动驾驶行驶前需确认控制遥控器及紧急制动功能可正常工作。
              </li>
              <li>
              ...
              <li>
                ...
                <ul>
                  <li>人工驾驶模式下操作者请时刻保持车辆处于视线范围以内， 同时密切关注车辆运行环境变化，及时提醒过往行人注意避让车辆或者停车让行。</li>
                  <li>车辆处于自动驾驶模式时请务必提前确认运行路线畅通，及时排除有可能导致安全事故以及导致车辆异常的因素。</li>
                </ul>
              </li>
              <li>
