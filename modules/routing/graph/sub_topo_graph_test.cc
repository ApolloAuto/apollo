...
TEST(SubTopoGraphTestSuit, two_sub_graph_nearby_find_start_node) {
    ...
    {
        const TopoNode* sub_node_1 =
            sub_topo_graph.GetSubNodeWithS(node_4, 25.0);
        ASSERT_TRUE(sub_node_1 == nullptr);
        const TopoNode* sub_node_2 =
            sub_topo_graph.GetSubNodeWithS(node_4, 55.0);
        ASSERT_TRUE(sub_node_2 == nullptr);
        const TopoNode* sub_node_3 =
            sub_topo_graph.GetSubNodeWithS(node_4, 80.0);
...
TEST(SubTopoGraphTestSuit, one_sub_graph_whole_lane_block) {
    ...
    {
        std::unordered_map<const TopoNode*, std::vector<NodeSRange>> range_list;
        range_list[node_1].push_back(GetSRange(TEST_LANE_LENGTH / 2,
                                               TEST_LANE_LENGTH / 2));
...

    {
        ...
        range_list[node_1].push_back(GetSRange(TEST_LANE_LENGTH / 2,
                                               TEST_LANE_LENGTH / 2));
        range_list[node_3].push_back(GetSRange(TEST_LANE_LENGTH / 2,
                                               TEST_LANE_LENGTH));
        SubTopoGraph sub_topo_graph(range_list);
...

    {
        ...
        range_list[node_1].push_back(GetSRange(TEST_LANE_LENGTH / 2,
                                               TEST_LANE_LENGTH / 2));
        range_list[node_3].push_back(GetSRange(TEST_LANE_LENGTH / 4,
                                               TEST_LANE_LENGTH / 2));
        range_list[node_3].push_back(GetSRange(TEST_LANE_LENGTH * 3 / 4,
                                               TEST_LANE_LENGTH));
        SubTopoGraph sub_topo_graph(range_list);
