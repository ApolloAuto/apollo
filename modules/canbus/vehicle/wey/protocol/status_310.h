...
class Status310 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::LateralaccevalidType lateralaccevalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::FlwheelspdvalidType flwheelspdvalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::FrwheelspdvalidType frwheelspdvalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::RlwheelspdvalidType rlwheelspdvalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::RrwheelspdvalidType rrwheelspdvalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  Status_310::VehiclespdvalidType vehiclespdvalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::EngspdvalidType engspdvalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::BrakepedalstatusType brakepedalstatus(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::EspbrakelightstsType espbrakelightsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::CurrentgearvalidType currentgearvalid(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::EpstrqsnsrstsType epstrqsnsrsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::EpshandsdetnstsType epshandsdetnsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::DriverdoorstsType driverdoorsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::RldoorstsType rldoorsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::PassengerdoorstsType passengerdoorsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::RrdoorstsType rrdoorsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'order': 'motorola', 'physical_unit': ''}
  Status_310::FrontfoglmpstsType frontfoglmpsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::RearfoglmpstsType rearfoglmpsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::LowbeamstsType lowbeamsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::HighbeamstsType highbeamsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::LeftturnlampstsType leftturnlampsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::RightturnlampstsType rightturnlampsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::Bcm_availstsType bcm_availsts(
    const std::uint8_t* bytes, const int32_t length) const;
  ...
  // 'physical_unit': ''}
  Status_310::BrakelmpstsType brakelmpsts(
    const std::uint8_t* bytes, const int32_t length) const;
};
