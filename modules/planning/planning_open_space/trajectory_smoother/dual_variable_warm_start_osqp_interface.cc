...
DualVariableWarmStartOSQPInterface::DualVariableWarmStartOSQPInterface(
    ...
    min_safety_distance_ = DualVariableWarmStartConfig.min_safety_distance();
    check_mode_ = DualVariableWarmStartConfig.debug_osqp();
    osqp_config_ = DualVariableWarmStartConfig.osqp_config();
}
