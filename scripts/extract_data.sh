...
TEMPLATE_DIR="${TOP_DIR}/docs/specs/Apollo_Fuel/examples/sensor_calibration/lidar_to_gnss"
...
function main() {
  ...
  install_if_not_exist "pyyaml" "pypcd" "numpy"

  python ${TOP_DIR}/modules/tools/sensor_calibration/extract_data.py \
