...
#include "modules/canbus/vehicle/esr/protocol/esr_status1_4e0.h"
...
double Esrstatus14e0::can_tx_dsp_timestamp(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
...
bool Esrstatus14e0::can_tx_comm_error(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
...
double Esrstatus14e0::can_tx_yaw_rate_calc(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 5);
...
double Esrstatus14e0::can_tx_vehicle_speed_calc(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 6);
...
int Esrstatus14e0::can_tx_scan_index(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 3);
  int32_t x = t0.get_byte(0, 8);
...
int Esrstatus14e0::can_tx_rolling_count_1(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
...
int Esrstatus14e0::can_tx_radius_curvature_calc(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 1);
  int32_t x = t0.get_byte(0, 6);
