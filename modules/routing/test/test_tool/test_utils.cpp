...
void get_node_detail_for_test(Node* const node,
    ...
    add_curve(node->mutable_central_curve());
...
void get_node_for_test(Node* const node, const std::string& lane_id, const std::string& road_id) {
    node->set_lane_id(lane_id);
    node->set_length(TEST_LANE_LENGTH);
    node->set_road_id(road_id);
    node->set_cost(TEST_LANE_COST);
...
void get_edge_for_test(Edge* const edge,
...
void get_graph_for_test(Graph* graph) {
    graph->set_hdmap_version(TEST_MAP_VERSION);
    graph->set_hdmap_district(TEST_MAP_DISTRICT);
    get_node_for_test(graph->add_node(), TEST_L1, TEST_R1);
    get_node_for_test(graph->add_node(), TEST_L2, TEST_R1);
    get_node_for_test(graph->add_node(), TEST_L3, TEST_R2);
    get_node_for_test(graph->add_node(), TEST_L4, TEST_R2);

    get_edge_for_test(graph->add_edge(), TEST_L1, TEST_L2, Edge::RIGHT);
    get_edge_for_test(graph->add_edge(), TEST_L2, TEST_L1, Edge::LEFT);
    get_edge_for_test(graph->add_edge(), TEST_L3, TEST_L4, Edge::RIGHT);
    get_edge_for_test(graph->add_edge(), TEST_L4, TEST_L3, Edge::LEFT);
    get_edge_for_test(graph->add_edge(), TEST_L1, TEST_L3, Edge::FORWARD);
    get_edge_for_test(graph->add_edge(), TEST_L2, TEST_L4, Edge::FORWARD);
}

void get_graph_2_for_test(Graph* graph) {
    graph->set_hdmap_version(TEST_MAP_VERSION);
    graph->set_hdmap_district(TEST_MAP_DISTRICT);
    get_node_for_test(graph->add_node(), TEST_L1, TEST_R1);
    get_node_for_test(graph->add_node(), TEST_L2, TEST_R1);
    get_node_for_test(graph->add_node(), TEST_L3, TEST_R2);
    get_node_for_test(graph->add_node(), TEST_L4, TEST_R2);
    get_node_for_test(graph->add_node(), TEST_L5, TEST_R2);
    get_node_for_test(graph->add_node(), TEST_L6, TEST_R3);

    get_edge_for_test(graph->add_edge(), TEST_L1, TEST_L2, Edge::RIGHT);
    get_edge_for_test(graph->add_edge(), TEST_L2, TEST_L1, Edge::LEFT);
    get_edge_for_test(graph->add_edge(), TEST_L3, TEST_L4, Edge::RIGHT);
    get_edge_for_test(graph->add_edge(), TEST_L4, TEST_L3, Edge::LEFT);
    get_edge_for_test(graph->add_edge(), TEST_L4, TEST_L5, Edge::RIGHT);
    get_edge_for_test(graph->add_edge(), TEST_L5, TEST_L4, Edge::LEFT);
    get_edge_for_test(graph->add_edge(), TEST_L1, TEST_L3, Edge::FORWARD);
    get_edge_for_test(graph->add_edge(), TEST_L2, TEST_L4, Edge::FORWARD);
    get_edge_for_test(graph->add_edge(), TEST_L5, TEST_L6, Edge::FORWARD);
}
