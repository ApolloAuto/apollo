...
class FeatureGenerator {
 public:
  ...
  /**
   * @brief Init the Feature Generator
   * 
   * @param feature_param params
   * @param out_blob output blobs
   * @return true 
   * @return false 
   */
  bool Init(const cnnseg::FeatureParam& feature_param,
            base::Blob<float>* out_blob);

  /**
   * @brief Generate features for cnnseg
   * 
   * @param pc_ptr input point cloud
   * @param point2grid point to grid mapping
   */
  ...
  /**
   * @brief Name of Feature Generator
   * 
   * @return std::string 
   */
