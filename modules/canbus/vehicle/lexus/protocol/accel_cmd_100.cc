...
Accelcmd100* Accelcmd100::set_ignore_overrides(
...
void Accelcmd100::set_p_ignore_overrides(uint8_t* data,
    bool ignore_overrides) {
...
Accelcmd100* Accelcmd100::set_enable(
    bool enable) {
  enable_ = enable;
  return this;
 }
...
void Accelcmd100::set_p_enable(uint8_t* data,
    bool enable) {
  int x = enable;
...
Accelcmd100* Accelcmd100::set_clear_override(
    bool clear_override) {
...
void Accelcmd100::set_p_clear_override(uint8_t* data,
    bool clear_override) {
...
Accelcmd100* Accelcmd100::set_clear_faults(
    bool clear_faults) {
...
void Accelcmd100::set_p_clear_faults(uint8_t* data,
    bool clear_faults) {
  int x = clear_faults;
...
Accelcmd100* Accelcmd100::set_accel_cmd(
    double accel_cmd) {
...
void Accelcmd100::set_p_accel_cmd(uint8_t* data,
    double accel_cmd) {
