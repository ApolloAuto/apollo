...
void Cruisecontrolbuttonscmd108::Reset() {
  ...
  cruise_control_button_ = Cruise_control_buttons_cmd_108::CRUISE_CONTROL_BUTTON_CRUISE_CONTROL_NONE;
...
void Cruisecontrolbuttonscmd108::set_p_cruise_control_button(uint8_t* data,
    Cruise_control_buttons_cmd_108::Cruise_control_buttonType cruise_control_button) {
  int x = cruise_control_button;
...
void Cruisecontrolbuttonscmd108::set_p_enable(uint8_t* data,
    bool enable) {
  int x = enable;
