...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_HORN_CMD_11C_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_HORN_CMD_11C_H_
...
class Horncmd11c : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Horn_cmd_11c::Horn_cmdType horn_cmd(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_HORN_CMD_11C_H_
