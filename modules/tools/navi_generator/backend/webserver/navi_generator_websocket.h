...
#ifndef MODULES_TOOLS_NAVI_GENERATOR_BACKEND_HANDLERS_WEBSOCKET_HANDLER_H_
#define MODULES_TOOLS_NAVI_GENERATOR_BACKEND_HANDLERS_WEBSOCKET_HANDLER_H_
...
class NaviGeneratorWebSocket : public CivetWebSocketHandler {
 ...
 public:
  ...
  explicit NaviGeneratorWebSocket(const std::string &name) : name_(name) {}
...
#endif  // MODULES_TOOLS_NAVI_GENERATOR_BACKEND_HANDLERS_WEBSOCKET_HANDLER_H_
