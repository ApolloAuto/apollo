...
MinibusVehicleFactory::CreateVehicleController() {
  return std::unique_ptr<VehicleController>(new minibus::MinibusController());
}

std::unique_ptr<MessageManager<::apollo::canbus::ChassisDetail>>
MinibusVehicleFactory::CreateMessageManager() {
  return std::unique_ptr<MessageManager<::apollo::canbus::ChassisDetail>>(
      new minibus::MinibusMessageManager());
}
