...
class ObstacleCameraPerception : public BaseCameraPerception {
 public:
  ObstacleCameraPerception() : transformer_(nullptr),
                                   tracker_(nullptr),
                                   extractor_(nullptr),
  ...
  ObstacleCameraPerception(
    const ObstacleCameraPerception &) =  delete;
  ObstacleCameraPerception &operator=(
    const ObstacleCameraPerception &) = delete;
 ...
 private:
  ...
  std::map<std::string,
    std::shared_ptr<BaseObstacleDetector>> name_detector_map_;
