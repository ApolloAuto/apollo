 ...
 * @file
 **/
#include "modules/planning/planning_open_space/trajectory_smoother/dual_variable_warm_start_osqp_interface.h"
...
TEST_F(DualVariableWarmStartOSQPInterfaceTest, optimize) {
    ...
    auto ipopt_config_tmp = planner_open_space_config_.dual_variable_warm_start_config().ipopt_config();
    ...
    app->Options()->SetNumericValue("acceptable_constr_viol_tol", ipopt_config_tmp.ipopt_acceptable_constr_viol_tol());
    app->Options()->SetNumericValue("min_hessian_perturbation", ipopt_config_tmp.ipopt_min_hessian_perturbation());
    app->Options()->SetNumericValue(
            "jacobian_regularization_value", ipopt_config_tmp.ipopt_jacobian_regularization_value());
    app->Options()->SetStringValue("print_timing_statistics", ipopt_config_tmp.ipopt_print_timing_statistics());
