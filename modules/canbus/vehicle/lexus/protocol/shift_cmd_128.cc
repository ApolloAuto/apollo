...
Shiftcmd128* Shiftcmd128::set_ignore_overrides(
...
void Shiftcmd128::set_p_ignore_overrides(uint8_t* data,
    bool ignore_overrides) {
...
Shiftcmd128* Shiftcmd128::set_enable(
    bool enable) {
  enable_ = enable;
  return this;
 }
...
void Shiftcmd128::set_p_enable(uint8_t* data,
    bool enable) {
  int x = enable;
...
Shiftcmd128* Shiftcmd128::set_clear_override(
    bool clear_override) {
...
void Shiftcmd128::set_p_clear_override(uint8_t* data,
    bool clear_override) {
...
Shiftcmd128* Shiftcmd128::set_clear_faults(
    bool clear_faults) {
...
void Shiftcmd128::set_p_clear_faults(uint8_t* data,
    bool clear_faults) {
  int x = clear_faults;
