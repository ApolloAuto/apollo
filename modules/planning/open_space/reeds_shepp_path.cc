...
bool ReedShepp::CCCC(double x, double y, double phi,
  ...
  double LRLRn2_lengths[4] = {-LRLRn2_param.t, -LRLRn2_param.u, LRLRn2_param.u,
                              -LRLRn2_param.v};
  char LRLRn2_types[4] = "LRLR";
  if (LRLRn2_param.flag &&
      !SetRSP(LRLRn2_param, LRLRn2_types, all_possible_paths)) {
  ...
  double LRLRn3_lengths[4] = {LRLRn3_param.t, LRLRn3_param.u, -LRLRn3_param.u,
                              LRLRn3_param.v};
  char LRLRn3_types[4] = "RLRL";
  if (LRLRn3_param.flag &&
      !SetRSP(LRLRn3_param, LRLRn3_types, all_possible_paths)) {
  ...
  double LRLRn4_lengths[4] = {-LRLRn4_param.t, -LRLRn4_param.u, LRLRn4_param.u,
                              -LRLRn4_param.v};
  char LRLRn4_types[4] = "RLRL";
  if (LRLRn4_param.flag &&
      !SetRSP(LRLRn4_param, LRLRn4_types, all_possible_paths)) {
  ...
  double LRLRp1_lengths[4] = {LRLRp1_param.t, LRLRp1_param.u, LRLRp1_param.u,
                              LRLRp1_param.v};
  char LRLRp1_types[4] = "LRLR";
  if (LRLRp1_param.flag &&
      !SetRSP(LRLRp1_param, LRLRp1_types, all_possible_paths)) {
  ...
  double LRLRp2_lengths[4] = {-LRLRp2_param.t, -LRLRp2_param.u, -LRLRp2_param.u,
                              -LRLRp2_param.v};
  char LRLRp2_types[4] = "LRLR";
  if (LRLRp2_param.flag &&
      !SetRSP(LRLRp2_param, LRLRp2_types, all_possible_paths)) {
  ...
  double LRLRp3_lengths[4] = {LRLRp3_param.t, LRLRp3_param.u, LRLRp3_param.u,
                              LRLRp3_param.v};
  char LRLRp3_types[4] = "RLRL";
  if (LRLRp3_param.flag &&
      !SetRSP(LRLRp3_param, LRLRp3_types, all_possible_paths)) {
  ...
  double LRLRp4_lengths[4] = {-LRLRp4_param.t, -LRLRp4_param.u, -LRLRp4_param.u,
                              -LRLRp4_param.v};
  char LRLRp4_types[4] = "RLRL";
  if (LRLRp4_param.flag &&
      !SetRSP(LRLRp4_param, LRLRp4_types, all_possible_paths)) {
...
bool ReedShepp::CCSC(double x, double y, double phi,
  ...
  double LRSL2_lengths[4] = {-LRSL2_param.t, 0.5 * M_PI, -LRSL2_param.u,
                             -LRSL2_param.v};
  char LRSL2_types[4] = "LRSL";
  if (LRSL2_param.flag &&
      !SetRSP(LRSL2_param, LRSL2_types, all_possible_paths)) {
  ...
  double LRSL3_lengths[4] = {LRSL3_param.t, -0.5 * M_PI, LRSL3_param.u,
                             LRSL3_param.v};
  char LRSL3_types[4] = "RLSR";
  if (LRSL3_param.flag &&
      !SetRSP(LRSL3_param, LRSL3_types, all_possible_paths)) {
  ...
  double LRSL4_lengths[4] = {-LRSL4_param.t, -0.5 * M_PI, -LRSL4_param.u,
                             -LRSL4_param.v};
  char LRSL4_types[4] = "RLSR";
  if (LRSL4_param.flag &&
      !SetRSP(LRSL4_param, LRSL4_types, all_possible_paths)) {
  ...
  double LRSR1_lengths[4] = {LRSR1_param.t, -0.5 * M_PI, LRSR1_param.u,
                             LRSR1_param.v};
  char LRSR1_types[4] = "LRSR";
  if (LRSR1_param.flag &&
      !SetRSP(LRSR1_param, LRSR1_types, all_possible_paths)) {
  ...
  double LRSR2_lengths[4] = {-LRSR2_param.t, 0.5 * M_PI, -LRSR2_param.u,
                             -LRSR2_param.v};
  char LRSR2_types[4] = "LRSR";
  if (LRSR2_param.flag &&
      !SetRSP(LRSR2_param, LRSR2_types, all_possible_paths)) {
  ...
  double LRSR3_lengths[4] = {LRSR3_param.t, -0.5 * M_PIu, LRSR3_param.u,
                             LRSR3_param.v};
  char LRSR3_types[4] = "RLSL";
  if (LRSR3_param.flag &&
      !SetRSP(LRSR3_param, LRSR3_types, all_possible_paths)) {
  ...
  double LRSR4_lengths[4] = {-LRSR4_param.t, 0.5 * M_PI, -LRSR4_param.u,
                             -LRSR4_param.v};
  char LRSR4_types[4] = "RLSL";
  if (LRSR4_param.flag &&
      !SetRSP(LRSR4_param, LRSR4_types, all_possible_paths)) {
  ...
  double LRSL6_lengths[4] = {-LRSL6_param.v, -LRSL6_param.u, 0.5 * M_PI,
                             -LRSL6_param.t};
  char LRSL6_types[4] = "LSRL";
  if (LRSL6_param.flag &&
      !SetRSP(LRSL6_param, LRSL6_types, all_possible_paths)) {
  ...
  double LRSL7_lengths[4] = {LRSL7_param.v, LRSL7_param.u, -0.5 * M_PI,
                             LRSL7_param.t};
  char LRSL7_types[4] = "RSLR";
  if (LRSL7_param.flag &&
      !SetRSP(LRSL7_param, LRSL7_types, all_possible_paths)) {
  ...
  double LRSL8_lengths[4] = {-LRSL8_param.v, -LRSL8_param.u, 0.5 * M_PI,
                             -LRSL8_param.t};
  char LRSL8_types[4] = "RSLR";
  if (LRSL8_param.flag &&
      !SetRSP(LRSL8_param, LRSL8_types, all_possible_paths)) {
  ...
  double LRSR5_lengths[4] = {LRSR5_param.v, LRSR5_param.u, -0.5 * M_PI,
                             LRSR5_param.t};
  char LRSR5_types[4] = "RSRL";
  if (LRSR5_param.flag &&
      !SetRSP(LRSR5_param, LRSR5_types, all_possible_paths)) {
  ...
  double LRSR6_lengths[4] = {-LRSR6_param.v, -LRSR6_param.u, 0.5 * M_PI,
                             -LRSR6_param.t};
  char LRSR6_types[4] = "RSRL";
  if (LRSR6_param.flag &&
      !SetRSP(LRSR6_param, LRSR6_types, all_possible_paths)) {
  ...
  double LRSR7_lengths[4] = {LRSR7_param.v, LRSR7_param.u, -0.5 * M_PI,
                             LRSR7_param.t};
  char LRSR7_types[4] = "LSLR";
  if (LRSR7_param.flag &&
      !SetRSP(LRSR7_param, LRSR7_types, all_possible_paths)) {
  ...
  double LRSR8_lengths[4] = {-LRSR8_param.v, -LRSR8_param.u, 0.5 * M_PI,
                             -LRSR8_param.t};
  char LRSR8_types[4] = "LSLR";
  if (LRSR8_param.flag &&
      !SetRSP(LRSR8_param, LRSR8_types, all_possible_paths)) {
...
void ReedShepp::SLS(double x, double y, double phi, RSPParam* param) {
  phi_mod = common::math::NormalizeAngle(phi);
  double xd = 0.0;
  double u = 0.0;
  double t = 0.0;
  double v = 0.0;
  if (y > 0.0 && phi > 0.0 && phi < M_PI * 0.99) {
    ...
    u = phi;
    v = std::sqrt((x - xd) * (x - xd) + y * y) - tan(phi / 2.0);
    param->flag = true;
    param->u = u;
    param->t = t;
    param->v = v;
    ...
    t = xd - std::tan(phi / 2.0);
    u = phi;
    v = -std::sqrt((x - xd) ^ 2 + y ^ 2) - std::tan(phi / 2.0);
    param->flag = true;
    param->u = u;
    param->t = t;
    param->v = v;
...
void ReedShepp::LRSR(double x, double y, double phi, RSPParam* param) {
  ...
  if (rho >= 2.0) {
    t = theta;
    u = 2.0 - rho;
    v = common::math::NormalizeAngle(t + 0.5 * pi - phi);
...
void ReedShepp::LRSL(double x, double y, double phi, RSPParam* param) {
  ...
  if (rho >= 2.0) {
    ...
    v = common::math::NormalizeAngle(phi - 0.5 * pi - t);
    if (t >= 0.0 && u <= 0.0 && v <= 0.0) {
      param->flag = true;
      param->u = u;
      param->t = t;
...
bool ReedShepp::SetRSP(double lengths[], char types[],
                       std::vector<ReedSheppPath>* all_possible_paths) {
  ReedSheppPath path;
  path.segs_lengths = lengths;
  path.segs_types = types;
  double sum = 0.0;
...
bool ReedShepp::GenerateLocalConfigurations(
    start_node, end_node, std::vector<ReedSheppPath>* all_possible_paths) {
  for (auto path : *all_possible_paths) {
    ...
    if (path->segs_lengths[0] > 0.0) {
      pgear.at(0) = true;
      d = open_space_conf_.step_size();
    } else {
      pgear.at(0) = false;
      p = -open_space_conf_.step_size();
    }
    pd = d;

    for (std::size_t i = 0; i < path->segs_types.size(); i++) {
      char m = path->segs_types[i];
      double l = path->segs_lengths[i];
      if (l > 0.0) {
        d = open_space_conf_.step_size();
      } else {
        d = -open_space_conf_.step_size();
      ...
      index--;
      if (i >= 1 && path->segs_lengths[i - 1] * path->segs_lengths[i] > 0) {
        pd = -d - ll;
      } else {
        pd = d - ll;
      }
      while (std::abs(pd) <= std::abs(l)) {
        index++;
        interpolation(double index, pd, m, ox, oy, ophi, px, py, pphi, pgear);
        pd += d;
      }
      ll = l - pd - d;
      index += 1;
      interpolation(double index, l, m, ox, oy, ophi, px, py, pphi, pgear);
    }
    ...
    path->gear = pgear;
    for (std::size_t i = 0; i < path->segs.lengths.size(); i++) {
      path->seges_length[i] = path->segs_lengths[i] / max_kappa_;
    }
...
void Interpolation(double index, double pd, char m, double ox, double oy,
                   double ophi, std::vector<double>& px, std
                   : vector<double>& py, std::vector<double>& pphi,
