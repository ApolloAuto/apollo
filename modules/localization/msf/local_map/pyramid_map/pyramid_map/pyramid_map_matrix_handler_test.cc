 ...
 *****************************************************************************/
#include "modules/localization/msf/local_map/pyramid_map/pyramid_map/pyramid_map_matrix_handler.h"
#include <gtest/gtest.h>
#include "modules/localization/msf/local_map/pyramid_map/base_map/base_map_matrix_handler.h"
...
TEST_F(PyramidMapMatrixHandlerTestSuite, LosslessMapMatrixHandler) {
  ...
  // create pyramid map matrix
  PyramidMapConfig* config = new PyramidMapConfig("lossy_map");
  config->SetMapNodeSize(2, 2);
  config->resolution_num_ = 1;
  PyramidMapMatrix* pm_matrix = new PyramidMapMatrix();
  pm_matrix->Init(*config);
...
TEST_F(PyramidMapMatrixHandlerTestSuite, PyramidLossyMapMatrixHandler) {
  ...
  // create pyramid map matrix
  PyramidMapConfig* config = new PyramidMapConfig("pyramid_lossy_map");
  config->SetMapNodeSize(2, 2);
  config->resolution_num_ = 1;
  PyramidMapMatrix* pm_matrix = new PyramidMapMatrix();
  pm_matrix->Init(*config);
...
TEST_F(PyramidMapMatrixHandlerTestSuite, PyramidLosslessMapMatrixHandler) {
  ...
  // create pyramid map matrix
  PyramidMapConfig* config = new PyramidMapConfig("pyramid_lossless_map");
  config->SetMapNodeSize(2, 2);
  config->resolution_num_ = 1;
  PyramidMapMatrix* pm_matrix = new PyramidMapMatrix();
  pm_matrix->Init(*config);
