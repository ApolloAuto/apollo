...
/**
 * @file zone_cover_command_processor.h
 **/
...
class ZoneCoverCommandProcessor : public MotionCommandProcessorBase<ZoneCoverCommand> {
private:
    /**
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::external_command::ZoneCoverCommandProcessor, CommandProcessorBase)
