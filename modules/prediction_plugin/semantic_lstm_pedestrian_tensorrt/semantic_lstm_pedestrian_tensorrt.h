...
class SemanticLstmPedestrianTensorrt : public ModelBase {
public:
...
private:
    ...
    const char* INPUT_IMAGE_NAME = "img_tensor";
    const char* INPUT_OBSTACLE_POS_NAME = "obstacle_pos";
    const char* INPUT_OBSTACLE_POS_STEP_NAME = "obstacle_pos_step";
    const char* OUTPUT_NAME = "predict";
    // input output index
    int input_image_index_;
    int input_obstacle_pos_index_;
    int input_obstacle_pos_step_index_;
    int output_index_;
    std::mutex mtx;
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::prediction::SemanticLstmPedestrianTensorrt, ModelBase)
