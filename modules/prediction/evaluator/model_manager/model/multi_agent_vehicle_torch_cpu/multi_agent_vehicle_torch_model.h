...
class MultiAgentVehicleCpuTorch : public ModelBase {
 public:
  /**
  * @brief Construct a new Multi Agent Vehicle Cpu Torch object
  * 
  */
  MultiAgentVehicleCpuTorch() {}
  /**
   * @brief Destroy the Multi Agent Vehicle Cpu Torch object
   * 
   */
  ~MultiAgentVehicleCpuTorch() {Destory();}
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(
  apollo::prediction::MultiAgentVehicleCpuTorch, ModelBase)
