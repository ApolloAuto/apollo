...
class Vehicle24f1 : public SensorProtocolData<DelphiESR> {
 public:
 ...
 private:
  ...
  double can_rx_volvo_short_track_roc(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_mr_only_transmitType can_rx_mr_only_transmit(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_lr_only_transmitType can_rx_lr_only_transmit(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int can_rx_high_yaw_angle(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_clear_faultsType can_rx_clear_faults(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_use_angle_misalignmentType can_rx_use_angle_misalignment(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_turn_signal_statusType can_rx_turn_signal_status(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_blockage_disableType can_rx_blockage_disable(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_vehicle_speed_validityType can_rx_vehicle_speed_validity(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_mmr_upside_downType can_rx_mmr_upside_down(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_wiper_statusType can_rx_wiper_status(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_raw_data_enableType can_rx_raw_data_enable(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_radar_cmd_radiateType can_rx_radar_cmd_radiate(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Vehicle2_4f1::Can_rx_grouping_modeType can_rx_grouping_mode(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int can_rx_maximum_tracks(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_lateral_mounting_offset(const std::uint8_t* bytes, const int32_t length) const;
  ...
  double can_rx_angle_misalignment(const std::uint8_t* bytes, const int32_t length) const;
  ...
  int can_rx_scan_index_ack(const std::uint8_t* bytes, const int32_t length) const;
};
