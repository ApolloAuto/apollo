...
void Globalcmd69::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_gem()->mutable_global_cmd_69()->set_pacmod_enable(pacmod_enable(bytes, length));
  chassis->mutable_gem()->mutable_global_cmd_69()->set_clear_override(clear_override(bytes, length));
  chassis->mutable_gem()->mutable_global_cmd_69()->set_ignore_override(ignore_override(bytes, length));
}
...
Global_cmd_69::Pacmod_enableType Globalcmd69::pacmod_enable(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(0, 1);

  Global_cmd_69::Pacmod_enableType ret =  static_cast<Global_cmd_69::Pacmod_enableType>(x);
  return ret;
}
...
Global_cmd_69::Clear_overrideType Globalcmd69::clear_override(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(1, 1);

  Global_cmd_69::Clear_overrideType ret =  static_cast<Global_cmd_69::Clear_overrideType>(x);
  return ret;
}
...
Global_cmd_69::Ignore_overrideType Globalcmd69::ignore_override(const std::uint8_t* bytes, int32_t length) const {
  Byte t0(bytes + 0);
  int32_t x = t0.get_byte(2, 1);

  Global_cmd_69::Ignore_overrideType ret =  static_cast<Global_cmd_69::Ignore_overrideType>(x);
  return ret;
}
}  // namespace gem
}  // namespace canbus
