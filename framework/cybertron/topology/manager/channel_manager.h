...
#ifndef CYBERTRON_TOPOLOGY_MANAGER_CHANNEL_MANAGER_H_
#define CYBERTRON_TOPOLOGY_MANAGER_CHANNEL_MANAGER_H_
...
#endif  //  CYBERTRON_TOPOLOGY_MANAGER_CHANNEL_MANAGER_H_
