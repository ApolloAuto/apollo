...
#include "modules/perception/radar4d_detection/lib/detector/point_pillars_detection/anchor_mask_cuda.h"
...
#include "modules/perception/radar4d_detection/lib/detector/point_pillars_detection/postprocess_cuda.h"
#include "modules/perception/radar4d_detection/lib/detector/point_pillars_detection/preprocess_points.h"
#include "modules/perception/radar4d_detection/lib/detector/point_pillars_detection/preprocess_points_cuda.h"
#include "modules/perception/radar4d_detection/lib/detector/point_pillars_detection/scatter_cuda.h"
...
class PointPillars {
 private:
  ...
  static const int kNumAnchorPerGrid;
  ...
  const common::Framework& model_type_;
 ...
 public:
   ...
   * @param[in] model_type Pillar Model type
   * @param[in] model_file Pillar Model file path
  ...
  /**
   * @brief Destroy the Point Pillars object
   * 
   */
  ~PointPillars();
