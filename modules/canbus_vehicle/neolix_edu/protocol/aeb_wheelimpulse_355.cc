...
void Aebwheelimpulse355::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_aeb_wheelimpulse_355()->set_flimpulse(
      flimpulse(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_flimpulsevalid(
      flimpulsevalid(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_frimpulse(
      frimpulse(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_frimpulsevalid(
      frimpulsevalid(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_rlimpulse(
      rlimpulse(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_rlimpulsevalid(
      rlimpulsevalid(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_rrimpulse(
      rrimpulse(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_rrimpulsevalid(
      rrimpulsevalid(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_alivecounter(
      alivecounter(bytes, length));
  chassis->mutable_aeb_wheelimpulse_355()->set_checksum(
