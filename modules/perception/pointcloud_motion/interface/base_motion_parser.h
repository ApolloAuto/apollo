...
private:
    DISALLOW_COPY_AND_ASSIGN(BaseMotionParser);
};  // class BaseMotionParser

PERCEPTION_REGISTER_REGISTERER(BaseMotionParser);
#define PERCEPTION_REGISTER_POINTCLOUDPARSER(name) PERCEPTION_REGISTER_CLASS(BaseMotionParser, name)
