...
/**
 * @file next_76d.h
 * @brief the class of 76d (for mobileye)
 */

#ifndef MODULES_DRIVERS_MOBILEYE_PROTOCOL_NEXT_76D_H
#define MODULES_DRIVERS_MOBILEYE_PROTOCOL_NEXT_76D_H
...
class Next76d : public ::apollo::drivers::canbus::ProtocolData<Mobileye> {
 public:
  static const int ID;
...
#endif  // MODULES_DRIVERS_MOBILEYE_PROTOCOL_NEXT_76D_H
