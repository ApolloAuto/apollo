...
#include "modules/planning/planning_base/lattice/trajectory_generation/lateral_osqp_optimizer.h"
#include "modules/planning/planning_base/lattice/trajectory_generation/lateral_qp_optimizer.h"
