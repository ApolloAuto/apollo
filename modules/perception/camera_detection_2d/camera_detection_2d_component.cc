 ...
 *****************************************************************************/
#include "modules/perception/camera_detection_2d/camera_detection_2d_component.h"
...
bool CameraDetection2dComponent::InitObstacleDetector(
    const CameraDetection2d& detection_param) {
...
bool CameraDetection2dComponent::InitCameraFrame(
    const CameraDetection2d& detection_param) {
...
bool CameraDetection2dComponent::InitTransformWrapper(
    const CameraDetection2d& detection_param) {
...
bool CameraDetection2dComponent::Init() {
  CameraDetection2d detection_param;
...
bool CameraDetection2dComponent::Proc(
...
bool CameraDetection2dComponent::InternalProc(
    const std::shared_ptr<apollo::drivers::Image>& msg,
