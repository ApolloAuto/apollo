 ...
 *****************************************************************************/
#include "modules/example/component_driver/driver_component.h"

#include <chrono>

#include "cybertron/common/log.h"
#include "cybertron/scheduler/task.h"
#include "modules/example/component_driver/proto/driver_conf.pb.h"

using apollo::cybertron::proto::RoleAttributes;
using apollo::modules::example::component_driver::proto::DriverConf;
...
bool DriverComponent::Init() {
  ...
  if (!GetProtoConfig(&conf)) {
    AERROR << "Parse config file error";
    return false;
  }


  RoleAttributes attr;
  attr.set_channel_name(conf.channel1());
  ...
  attr.set_channel_name(conf.channel2());
