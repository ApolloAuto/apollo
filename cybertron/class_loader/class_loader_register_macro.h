...
#ifndef CYBERTRON_CLASS_LOADER_CLASS_LOADER_REGISTER_MACRO_H_
#define CYBERTRON_CLASS_LOADER_CLASS_LOADER_REGISTER_MACRO_H_
...
#define CLASS_LOADER_REGISTER_CLASS_INTERNAL(Derived, Base, UniqueID)         \
  ...
  struct ProxyType##UniqueID {                                                \
    ProxyType##UniqueID() {                                                   \
      apollo::cybertron::class_loader::utility::RegisterClass<Derived, Base>( \
          #Derived, #Base);                                                   \
    }                                                                         \
  };                                                                          \
...
#endif  // CYBERTRON_CLASS_LOADER_CLASS_LOADER_REGISTER_MACRO_H_
