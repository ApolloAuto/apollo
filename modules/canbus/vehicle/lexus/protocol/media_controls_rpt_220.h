...
class Mediacontrolsrpt220 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Media_controls_rpt_220::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Media_controls_rpt_220::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Media_controls_rpt_220::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
