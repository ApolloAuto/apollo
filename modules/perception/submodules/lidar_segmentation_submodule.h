...
class LidarSegmentationSubmodule
    : public cyber::Component<drivers::PointCloud> {
 public:
  LidarSegmentationSubmodule() : segmentor_(nullptr) {}

  ~LidarSegmentationSubmodule() = default;
...
CYBER_REGISTER_COMPONENT(LidarSegmentationSubmodule);
