...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_HEADLIGHT_RPT_218_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_HEADLIGHT_RPT_218_H_
...
class Headlightrpt218 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Headlight_rpt_218::Output_valueType output_value(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Headlight_rpt_218::Manual_inputType manual_input(const std::uint8_t* bytes, const int32_t length) const;
  ...
  Headlight_rpt_218::Commanded_valueType commanded_value(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_HEADLIGHT_RPT_218_H_
