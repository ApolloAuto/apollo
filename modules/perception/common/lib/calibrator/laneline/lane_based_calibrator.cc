 ...
 *****************************************************************************/
#include "modules/perception/common/lib/calibrator/laneline/lane_based_calibrator.h"
...
void CalibratorParams::Init() {
  ...
  max_allowed_yaw_angle_in_radian = algorithm::IDegreeToRadians(3.0f);
  ...
  hist_estimator_params.data_sp = -algorithm::IDegreeToRadians(10.0f);
  // -10 ~ 10 degree
