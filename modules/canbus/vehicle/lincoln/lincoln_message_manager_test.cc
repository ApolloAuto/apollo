...
TEST_F(LincolnMessageManagerTest, Accel6b) {
  ...
  ProtocolData* pd = manager.GetMutableProtocolDataById(Accel6b::ID);
...
TEST_F(LincolnMessageManagerTest, Brake60) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Brake60::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Brake61) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Brake61::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Brakeinfo74) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Brakeinfo74::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Fuellevel72) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Fuellevel72::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Gear66) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Gear66::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Gear67) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Gear67::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Gps6d) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Gps6d::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Gps6e) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Gps6e::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Gps6f) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Gps6f::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Gyro6c) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Gyro6c::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Misc69) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Misc69::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Steering64) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Steering64::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Steering65) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Steering65::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Throttle62) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Throttle62::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Throttle63) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Throttle63::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Throttleinfo75) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Throttleinfo75::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Tirepressure71) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Tirepressure71::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Turnsignal68) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Turnsignal68::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Version7f) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Version7f::ID);
  EXPECT_TRUE(pd != nullptr);
...
TEST_F(LincolnMessageManagerTest, Wheelspeed6a) {
  LincolnMessageManager manager;
  ProtocolData* pd = manager.GetMutableProtocolDataById(Wheelspeed6a::ID);
  EXPECT_TRUE(pd != nullptr);
