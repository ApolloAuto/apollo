...
class TrafficLightUnprotectedLeftTurnStageApproachTest
 ...
 public:
  virtual void SetUp() {
    config_.set_name("TRAFFIC_LIGHT_UNPROTECTED_LEFT_TURN_APPROACH");
...
TEST_F(TrafficLightUnprotectedLeftTurnStageApproachTest, Init) {
  TrafficLightUnprotectedLeftTurnStageApproach
      traffic_light_unprotected_left_turn_stage_approach;
  traffic_light_unprotected_left_turn_stage_approach.Init(
