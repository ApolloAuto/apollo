...
class CS2DAffinityTracker : public BaseAffinityTracker {
 ...
 private:
  float sz_lim_ = 0.2f;  // max 2d box scale change
  float pos_range_ = 0.4f;  // max 2D center change, based on 2d box size
  float center_range_ = 3.0f;  // max diff in meter between unfiltered 3d pos
};
