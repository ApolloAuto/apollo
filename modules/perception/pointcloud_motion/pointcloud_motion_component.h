...
#include "modules/perception/pointcloud_motion/proto/pointcloud_motion_component_config.pb.h"
...
class PointCloudMotionComponent final : public cyber::Component<LidarFrameMessage> {
public:
    PointCloudMotionComponent() {}
    virtual ~PointCloudMotionComponent() {}
    /**
     * @brief Init pointcloud motion component
     *
     * @return true
     * @return false
     */
    bool Init() override;
    /**
     * @brief Process of pointcloud motion component
     *
...
CYBER_REGISTER_COMPONENT(PointCloudMotionComponent);
