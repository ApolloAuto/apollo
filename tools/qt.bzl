...
def qt_cc_library(name, src, hdr, uis = [], res = [], normal_hdrs = [], deps = None, **kwargs):  
    ...
    for hItem in hdr:
        ...
        native.genrule(
            ...
            then /apollo/third_party/Qt5.5.1/5.5/gcc_64/bin/moc $(location %s) -o $@ -f'%s'; \
    ...
    for uitem in uis:
      ...
      native.genrule(
          ...
          cmd = "/apollo/third_party/Qt5.5.1/5.5/gcc_64/bin/uic $(locations %s) -o $@" % uitem,
      )
    ...
    for ritem in res:
      ...
      native.genrule(
          ...
          cmd = "/apollo/third_party/Qt5.5.1/5.5/gcc_64/bin/rcc --name res --output $(OUTS) $(location %s)" % ritem,
      )
