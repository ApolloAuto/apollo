...
class StageParkingRetryPark : public Stage {
 public:
 ...
 private:
  ...
  void CheckParkingAccuracy(Frame* frame);

  ScenarioValetParkingParkConfig scenario_config_;
  bool arrive_parking_spot_ = false;
};

CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::planning::StageParkingRetryPark, Stage)
