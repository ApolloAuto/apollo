...
#include "modules/perception/common/camera/common/lane_object.h"
#include "modules/perception/common/lib/interface/base_cipv.h"
...
class Cipv : public BaseCipv {
 public:
  ...
  bool Process(CameraFrame *frame, const CipvOptions &options,
