...
void Vcudrivereport52::Parse(const std::uint8_t* bytes, int32_t length,
  ...
  chassis->mutable_vcu_drive_report_52()->set_drive_enable_resp(
      drive_enable_resp(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_control_mode_resp(
      control_mode_resp(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_vcu_real_shift(
      vcu_real_shift(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_vcu_real_shift_valid(
      vcu_real_shift_valid(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_vcu_real_torque_valid(
      vcu_real_torque_valid(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_vcu_real_torque(
      vcu_real_torque(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_vcu_limitedtorquemode(
      vcu_limitedtorquemode(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_vcu_driverept_alivecounter(
      vcu_driverept_alivecounter(bytes, length));
  chassis->mutable_vcu_drive_report_52()->set_vcu_driverept_checksum(
