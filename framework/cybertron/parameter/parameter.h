...
#ifndef CYBERTRON_PARAMETER_PARAMETER_H_
#define CYBERTRON_PARAMETER_PARAMETER_H_

#include <string>
#include "cybertron/common/log.h"
#include "cybertron/proto/parameter.pb.h"
/**
 * @namespace cybertron.parameter
 */
namespace apollo {
namespace cybertron {
...
class Parameter {
 public:
  ...
  /**
   * @brief Parse a cybertron::proto::Param object to
   * cybertron::parameter::Parameter object
   * @param param The cybertron::proto::Param object parse from
  ...
  /**
   * @brief Parse a cybertron::parameter::Parameter object to
   * cybertron::proto::Param object
   * @return The target cybertron::proto::Param object
   */
  Param ToProtoParam() const;

  /**
   * @brief Get the cybertron:parameter::ParameterType of this object
   * @return cybertron:parameter::ParameterType
   */
...
#endif  // CYBERTRON_PARAMETER_PARAMETER_H_
