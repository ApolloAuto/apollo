...
#include "modules/map/tools/map_datachecker/server/alignment_agent.hpp"
...
class MapDataCheckerAgent final
 ...
 public:
  ...
  grpc::Status ChannelVerify(
      ...
      apollo::hdmap::CHANNEL_VERIFY_REQUEST_TYPE *request,
      apollo::hdmap::CHANNEL_VERIFY_RESPONSE_TYPE *response);
  grpc::Status StaticAlign(grpc::ServerContext *context,
                           STATIC_REQUEST_TYPE *request,
                           STATIC_RESPONSE_TYPE *response);
  grpc::Status EightRoute(grpc::ServerContext *context,
                          EIGHTROUTE_REQUEST_TYPE *request,
                          EIGHTROUTE_RESPONSE_TYPE *response);
  grpc::Status LoopsVerify(grpc::ServerContext *context,
