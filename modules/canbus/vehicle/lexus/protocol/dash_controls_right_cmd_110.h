...
#ifndef MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_DASH_CONTROLS_RIGHT_CMD_110_H_
#define MODULES_CANBUS_VEHICLE_LEXUS_PROTOCOL_DASH_CONTROLS_RIGHT_CMD_110_H_
...
class Dashcontrolsrightcmd110 : public ::apollo::drivers::canbus::ProtocolData<
 ...
 private:
  ...
  Dash_controls_right_cmd_110::Dash_controls_buttonType dash_controls_button(const std::uint8_t* bytes, const int32_t length) const;
};
...
#endif  // MODULES_CANBUS_VEHICL_LEXUS_PROTOCOL_DASH_CONTROLS_RIGHT_CMD_110_H_
