...
GemMessageManager::GemMessageManager() {
  ...
  AddRecvProtocolData<Brakecmd6b, true>();
  ...
  AddRecvProtocolData<Globalcmd69, true>();
  AddRecvProtocolData<Globalrpt6a, true>();
  AddRecvProtocolData<Headlightcmd76, true>();
  AddRecvProtocolData<Headlightrpt77, true>();
  AddRecvProtocolData<Horncmd78, true>();
  ...
  AddRecvProtocolData<Shiftcmd65, true>();
  AddRecvProtocolData<Shiftrpt66, true>();
  AddRecvProtocolData<Steeringcmd6d, true>();
