...
class ControlTask {
 ...
 protected:
  ...
  bool LoadCalibrationTable(calibration_table* calibration_table_conf) {
    ...
    std::string calibration_table_path = control_base_dir +
        "conf/calibration_table.pb.txt";

    if (!apollo::cyber::common::GetProtoFromFile(
      calibration_table_path, calibration_table_conf)) {
...
bool ControlTask::LoadConfig(T* config) {
  ...
  std::string config_dir_ =
                    ...
                    GetPluginClassHomePath<ControlTask>(class_name) +
                "/conf";
  std::string config_path_ = config_dir_ + "/controller_conf.pb.txt";
