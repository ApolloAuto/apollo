...
class BaseMotionFusion {
 public:
  ...
  /**
   * @brief update track motion state with measurement
   *
   * @param measurement
  ...
  /**
   * @brief update track motion state without measurement
   *
   * @param sensor_id
  ...
  /**
   * @brief The name of BaseMotionFusion
   *
   * @return std::string
   */
 ...
 protected:
  ...
  DISALLOW_COPY_AND_ASSIGN(BaseMotionFusion);
};
