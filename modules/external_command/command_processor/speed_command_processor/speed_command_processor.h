...
private:
     ...
     */
    void OnCommand(const std::shared_ptr<SpeedCommand>& command, std::shared_ptr<CommandStatus>& status);
...
CYBER_PLUGIN_MANAGER_REGISTER_PLUGIN(apollo::external_command::SpeedCommandProcessor, CommandProcessorBase)
