...
#ifndef CYBERTRON_TF2_LINEARMATH_SCALAR_H_
#define CYBERTRON_TF2_LINEARMATH_SCALAR_H_
...
#else
//#define INCLUDE_CYBERTRON_TF2_LINEARMATH_SCALAR_H_
...
//			#pragma warning(disable:4786) // Disable the "debug name
// too
// long" warning
...
#define TF2_DECLARE_ALIGNED_ALLOCATOR()                                      \
  ...
  TF2SIMD_FORCE_INLINE void *operator new [](size_t sizeInBytes) {           \
    ...
    tf2AlignedFree(ptr);                                                     \
      } TF2SIMD_FORCE_INLINE void *operator new [](size_t,                   \
                                                   void *ptr) {              \
    return ptr;                                                              \
      } TF2SIMD_FORCE_INLINE void operator delete [](void *, void *) {}
...
/// might 'correct' invalid floating point values
...
#endif  // INCLUDE_CYBERTRON_TF2_LINEARMATH_SCALAR_H_
