...
//       "modules/perception/common/inference/inference_test_data/images/";
//   std::string image_ext = ".jpg";
//   std::string output_blob_path =
//       "modules/perception/common/inference/inference_test_data/yolo/blob_names.txt";
//   std::string proto_file =
//       "modules/perception/common/inference/inference_test_data/yolo/caffe.pt";
//   std::string weight_file =
//       "modules/perception/common/inference/inference_test_data/yolo/caffe.caffemodel";
//   std::string result_file =
//       "modules/perception/common/inference/inference_test_data/yolo/result.dat";
